...
@Library(['camunda-ci', 'cambpm-jenkins-shared-library@3089']) _
        ...
        cambpmConditionalRetry([
          ...
          runSteps: {
            ...
            script {
              ...
              if (cambpmWithLabels(false, 'webapp-integration', 'all-as', 'h2', 'websphere', 'weblogic', 'jbosseap', 'run', 'spring-boot', 'authorizations', 'e2e')) {
