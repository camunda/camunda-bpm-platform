        ...
        cambpmConditionalRetry([
          ...
          runSteps: {
            ...
            script {
              ...
              if (env.BRANCH_NAME == cambpmDefaultBranch() || cambpmWithLabels(false, 'webapp-integration', 'all-as', 'h2', 'websphere', 'weblogic', 'jbosseap', 'run', 'spring-boot', 'authorizations', 'e2e')) {
