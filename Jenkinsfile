    ...
    stage('ASSEMBLY') {
      ...
      steps {
        cambpmConditionalRetry([
          ...
          runSteps: {
            cambpmRunMaven('.',
                'clean source:jar deploy source:test com.mycila:license-maven-plugin:check -Pdistro,distro-ce,distro-wildfly,distro-webjar -DaltStagingDirectory=${WORKSPACE}/staging -DskipRemoteStaging=true',
                withCatch: false,
                withNpm: true)
