...
Most of the components that make up the platform can even be completely embedded inside an application. For instance, you can add the process engine and the REST APIs a library to your application and assemble your custom BPM platform configuration.
