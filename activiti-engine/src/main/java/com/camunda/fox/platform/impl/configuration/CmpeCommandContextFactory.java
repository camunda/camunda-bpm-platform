 ...
 * @author Daniel Meyer
 */
public class CmpeCommandContextFactory extends CommandContextFactory implements ProcessArchiveServicesSupport {
  
  private ProcessArchiveServices processArchiveServices;

  @Override
  public CommandContext createCommandContext(Command< ? > cmd) {
    CmpeCommandContext containerCommandContext = new CmpeCommandContext(cmd,processEngineConfiguration);
    containerCommandContext.setProcessArchiveServices(processArchiveServices);
    return containerCommandContext;
  }
