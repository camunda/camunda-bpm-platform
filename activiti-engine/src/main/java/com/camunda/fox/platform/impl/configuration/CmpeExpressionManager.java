 ...
 * @author Daniel Meyer
 */
public class CmpeExpressionManager extends ExpressionManager {
    
  protected final ProcessArchiveServices paServices;

  public CmpeExpressionManager(ProcessArchiveServices paServices) {
