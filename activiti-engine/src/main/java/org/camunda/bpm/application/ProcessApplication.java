...
public abstract class ProcessApplication {
  ...
  /**
   * Start this {@link ProcessApplication}. 
   */
  public void start() {
  ...
  /**
   * Stop this {@link ProcessApplication}
   */
  public void stop() {
  ...
  public String getName() {
    Class<? extends ProcessApplication> processApplicationClass = getClass();
    String name = null;
    
    try {
      ProcessEngineClient annotation = processApplicationClass.getAnnotation(ProcessEngineClient.class);      
   ...
   * {@link ProcessEngineClient} annotation was used but without parameter.
   */
