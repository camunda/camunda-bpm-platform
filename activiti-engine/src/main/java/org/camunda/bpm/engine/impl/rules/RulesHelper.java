...
package org.camunda.bpm.engine.impl.rules;
...
public class RulesHelper {
  ...
  public static KnowledgeBase findKnowledgeBaseByDeploymentId(String deploymentId) {
    ...
    if (knowledgeBase==null) {
      ...
      if (deployment==null) {
        throw new ProcessEngineException("no deployment with id "+deploymentId);
      }
      Context
        .getProcessEngineConfiguration()
        .getDeploymentCache()
      ...
      if (knowledgeBase==null) {
        throw new ProcessEngineException("deployment "+deploymentId+" doesn't contain any rules");
      }
    }
