...
public class ScriptCondition implements Condition {
  ...
  public boolean evaluate(DelegateExecution execution) {
    ...
    if (result == null) {
      throw new ProcessEngineException("condition script returns null: " + expression);
    }
    if (!(result instanceof Boolean)) {
      throw new ProcessEngineException("condition script returns non-Boolean: " + result + " (" + result.getClass().getName() + ")");
    }
