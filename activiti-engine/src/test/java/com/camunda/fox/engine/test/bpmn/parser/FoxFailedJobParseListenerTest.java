package com.camunda.fox.engine.test.bpmn.parser;
...
public class FoxFailedJobParseListenerTest extends PluggableActivitiTestCase {

  @Deployment
          (resources = 
                { "com/camunda/fox/engine/test/bpmn/parser/FoxFailedJobParseListenerTest.testUserTask.bpmn20.xml" })
  ...
  @Deployment
          (resources = 
                { "com/camunda/fox/engine/test/bpmn/parser/FoxFailedJobParseListenerTest.testTimer.bpmn20.xml" })
  ...
  @Deployment
          (resources = 
                { "com/camunda/fox/engine/test/bpmn/parser/FoxFailedJobParseListenerTest.testSignal.bpmn20.xml" })
