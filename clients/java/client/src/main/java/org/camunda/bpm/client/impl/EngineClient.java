...
public class EngineClient {
  ...
  public EngineClient(String workerId,Long asyncResponseTimeout, String baseUrl, RequestExecutor engineInteraction) {
    this(workerId, asyncResponseTimeout, baseUrl, engineInteraction, true);
  }

  public EngineClient(String workerId, Long asyncResponseTimeout, String baseUrl, RequestExecutor engineInteraction, boolean usePriority) {
  ...
  public List<ExternalTask> fetchAndLock(List<TopicRequestDto> topics, int toFetch) throws EngineClientException {
    FetchAndLockRequestDto payload = new FetchAndLockRequestDto(workerId, toFetch, asyncResponseTimeout, topics, usePriority);
