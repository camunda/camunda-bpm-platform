 ...
 */
public class EngineClientLogger extends ClientLogger {
  ...
  public <D extends AbstractDto> EngineClientException exceptionWhileSerializingJsonObject(D dto, Throwable e) {
    return new EngineClientException(exceptionMessage(
