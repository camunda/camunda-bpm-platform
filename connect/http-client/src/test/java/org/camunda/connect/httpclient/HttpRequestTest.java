...
public class HttpRequestTest {
  ...
  public void setRequestConfig() {
    HttpRequest request = connector.createRequest().configOption("throw-http-error", "TRUE").configOption("connection-timeout", "10000")
    		.configOption("socket-timeout", "30000");
    assertThat(request.getConfigOptions())
      .hasSize(3)
