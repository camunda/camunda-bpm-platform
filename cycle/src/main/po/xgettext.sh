...
xgettext --copyright-holder='camunda services GmbH' --package-name='camunda fox cycle Webapp' --package-version='1.0-SNAPSHOT' --msgid-bugs-address='info@camunda.com' $*
