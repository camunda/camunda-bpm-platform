...
public class SignavioConnectorTest {
  ...
  public void shouldBeConfigurableViaXml() throws Exception  {
    assertNotNull(this.signavioConnector.getConfigurationValues());
    assertEquals("http://vm2.camunda.com:8080", this.signavioConnector.getConfigurationValues().get("signavioBaseUrl"));
    
    assertEquals("My SignavioConnector", this.signavioConnector.getName());
    
    ConnectorNode node = new ConnectorNode();
    node.setName("9b865d020a9d4714a189caeffec772e3");
