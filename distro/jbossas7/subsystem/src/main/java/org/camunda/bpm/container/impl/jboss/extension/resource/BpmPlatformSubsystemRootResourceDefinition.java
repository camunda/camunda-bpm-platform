...
public class BpmPlatformSubsystemRootResourceDefinition extends SimpleResourceDefinition {

  private static final PathElement SUBSYSTEM_PATH  = PathElement.pathElement(SUBSYSTEM, ModelConstants.SUBSYSTEM_NAME);

  public static final BpmPlatformSubsystemRootResourceDefinition INSTANCE = new BpmPlatformSubsystemRootResourceDefinition();

  private BpmPlatformSubsystemRootResourceDefinition() {
      super(SUBSYSTEM_PATH, BpmPlatformExtension.getResourceDescriptionResolver(ModelConstants.SUBSYSTEM_NAME),
