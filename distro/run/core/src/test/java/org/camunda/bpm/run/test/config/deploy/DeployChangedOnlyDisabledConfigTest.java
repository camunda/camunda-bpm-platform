...
@TestPropertySource(properties = { "camunda.bpm.run.deploy-changed-only.enabled=false" })
public class DeployChangedOnlyDisabledConfigTest extends AbstractRestTest {
