...
@TestPropertySource(properties = { "camunda.bpm.run.deploy-changed-only.enabled=true" })
public class DeployChangedOnlyEnabledConfigTest extends AbstractRestTest {
