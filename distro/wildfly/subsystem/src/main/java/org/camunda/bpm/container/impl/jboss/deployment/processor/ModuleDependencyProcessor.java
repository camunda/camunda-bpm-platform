...
public class ModuleDependencyProcessor implements DeploymentUnitProcessor {
  ...
  public void deploy(DeploymentPhaseContext phaseContext) throws DeploymentUnitProcessingException {
    ...
    final ServiceBuilder<?> serviceBuilder = phaseContext.getRequirementServiceTarget().addService();
  ...
  private void addSystemDependency(ModuleLoader moduleLoader, final ModuleSpecification moduleSpecification, String dependency) {
    addSystemDependency(moduleLoader, moduleSpecification, dependency, false);
  }

  private void addSystemDependency(ModuleLoader moduleLoader, final ModuleSpecification moduleSpecification, String dependency, boolean importServices) {
