 ...
 * @author Daniel Meyer
 */
public class MscRuntimeContainerDelegateCopy implements ServiceDependency<MscRuntimeContainerDelegateCopy>, RuntimeContainerDelegate, ProcessEngineService, ProcessApplicationService {
  ...
  public MscRuntimeContainerDelegateCopy() {
  }
  ...
  public MscRuntimeContainerDelegateCopy getValue() throws IllegalStateException, IllegalArgumentException {
    return this;
  }
  ...
  protected void createJndiBindings() {
    ...
    final PlatformServiceReferenceFactoryCopy managedReferenceFactory = new PlatformServiceReferenceFactoryCopy(this);
   ...
   * @author Daniel Meyer
   */
  public class PlatformServiceReferenceFactoryCopy implements ManagedReferenceFactory {

    private final MscRuntimeContainerDelegateCopy service;

    public PlatformServiceReferenceFactoryCopy(MscRuntimeContainerDelegateCopy service) {
  ...
  @Override
  public MscRuntimeContainerDelegateCopy get() {
    return this;
  }
