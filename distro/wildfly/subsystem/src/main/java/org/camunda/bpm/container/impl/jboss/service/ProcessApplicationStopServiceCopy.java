 ...
 *
 */
public class ProcessApplicationStopServiceCopy implements ServiceDependency<ProcessApplicationStopServiceCopy> {


  private final static Logger LOGGER = Logger.getLogger(ProcessApplicationStopServiceCopy.class.getName());

  // for view-exposing ProcessApplicationComponents
  protected  Supplier<ComponentView> paComponentViewSupplier;
  protected  Supplier<ProcessApplicationInterface> noViewApplicationSupplier;
  protected  Supplier<BpmPlatformPlugins> platformPluginsSupplier;
  protected  Consumer<ProcessApplicationStopServiceCopy> provider;

  public ProcessApplicationStopServiceCopy() {
  }
  public ProcessApplicationStopServiceCopy(Supplier<ComponentView> paComponentViewSupplier,
      Supplier<ProcessApplicationInterface> noViewApplicationSupplier,
      Supplier<BpmPlatformPlugins> platformPluginsSupplier, Consumer<ProcessApplicationStopServiceCopy> provider) {
  ...
  public ProcessApplicationStopServiceCopy getValue() throws IllegalStateException, IllegalArgumentException {
    return this;
  }
  ...
  @Override
  public ProcessApplicationStopServiceCopy get() {
    return this;
  }

  @Override
  public void accept(RequirementServiceBuilder<?> t) {
