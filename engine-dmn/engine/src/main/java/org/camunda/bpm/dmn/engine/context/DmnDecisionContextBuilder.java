...
public interface DmnDecisionContextBuilder<T> {
  ...
  DmnDecisionContextBuilder<T> setScriptContext(DmnScriptContext scriptContext);

  DmnDecisionContextBuilder<T> setDefaultScriptLanguage(String defaultScriptLanguage);
