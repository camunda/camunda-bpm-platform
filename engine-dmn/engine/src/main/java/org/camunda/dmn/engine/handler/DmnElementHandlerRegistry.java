...
package org.camunda.dmn.engine.handler;
...
public interface DmnElementHandlerRegistry {
  ...
  <Target extends DmnModelElementInstance, Source> DmnElementHandler<Target, Source> getElementHandler(Class<Target> elementClass);
