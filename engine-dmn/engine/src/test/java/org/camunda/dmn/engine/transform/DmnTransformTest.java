...
import static org.camunda.dmn.engine.impl.context.DmnScriptContextImpl.DEFAULT_SCRIPT_LANGUAGE;
...
import org.camunda.dmn.engine.DmnTypeDefinition;
...
public class DmnTransformTest {
  ...
  public static void readModelFromFile() {
    InputStream inputStream = IoUtil.fileAsStream("org/camunda/dmn/engine/transform/DmnTransformTest.dmn");
  ...
  public void shouldTransformDefinitions() {
    ...
    assertThat(decisionModel.getExpressionLanguage()).isEqualTo(DEFAULT_SCRIPT_LANGUAGE);
  }
