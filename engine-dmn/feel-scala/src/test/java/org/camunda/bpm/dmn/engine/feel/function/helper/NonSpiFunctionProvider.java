...
public class NonSpiFunctionProvider implements FeelCustomFunctionProvider {

  protected Map<String, CustomFunction> functions = new HashMap<>();

  public NonSpiFunctionProvider() {
  }

  public NonSpiFunctionProvider(String name, String value) {
