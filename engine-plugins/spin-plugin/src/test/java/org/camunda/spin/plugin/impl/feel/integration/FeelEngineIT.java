...
public class FeelEngineIT {
  ...
  protected static final String DMN_SPIN_JSON_VAR_RULE =
      "org/camunda/spin/plugin/impl/feel/integration/DecisionFEELInputJSON.dmn11.xml";
  protected static final String DMN_SPIN_XML_VAR_RULE =
      "org/camunda/spin/plugin/impl/feel/integration/DecisionFEELInputXML.dmn11.xml";
  protected static final String BPMN_BUSINESS_TASK_PROCESS =
      "org/camunda/spin/plugin/DmnBusinessRuleTaskResultMappingTest.testSingleEntry.bpmn20.xml";
  ...
  public void shouldExecuteProcessWithJSONVariableCorrectly() {
    ...
    // then
    HistoricDecisionInstance hdi = historyService
