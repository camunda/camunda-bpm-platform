...
public class ResteasyTomcatServerBootstrap extends TomcatServerBootstrap {
  ...
  protected void addRuntimeSpecificLibraries(WebArchive wa, PomEquippedResolveStage resolver) {
    ...
    wa.addAsLibraries(resolver.addDependencies(
      MavenDependencies.createDependency("org.jboss.resteasy:resteasy-core:" + restEasyVersion, ScopeType.TEST, false)).resolve()
      // TODO MavenDependencies.createDependency("org.jboss.resteasy:resteasy-core:" + restEasyVersion, ScopeType.TEST, false)).resolve()
