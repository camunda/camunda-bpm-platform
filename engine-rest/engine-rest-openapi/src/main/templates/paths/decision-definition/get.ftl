{
  <@lib.endpointInfo
      ...
      desc = "Queries for decision definitions that fulfill given parameters.
              ...
              The size of the result set can be retrieved by using the [Get Decision Definition Count](${docsUrl}/reference/rest/decision-definition/get-query-count/) method." />
