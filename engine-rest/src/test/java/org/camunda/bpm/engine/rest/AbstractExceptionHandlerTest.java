...
public abstract class AbstractExceptionHandlerTest extends AbstractRestServiceTest {
  ...
  //    TODO remove "resourceName", "resourceId", "permissionName" once the deprecated methods from AuthorizationException are removed
    ...
    .expect().contentType(ContentType.JSON)
      ...
      .body("info.resourceName", hasItems("someResourceName"))
      .body("info.resourceId", hasItems("someResourceId"))
      .body("info.permissionName", hasItems("somePermission"))
  ...
  //    TODO remove "resourceName", "resourceId", "permissionName" once the deprecated methods from AuthorizationException are removed
    ...
    .expect().contentType(ContentType.JSON)
      ...
      .body("info.resourceName", hasItems("someResourceName1", "someResourceName2"))
      .body("info.resourceId", hasItems("someResourceId1", "someResourceId2"))
      .body("info.permissionName", hasItems("somePermission1", "somePermission2"))
