...
public abstract class AbstractJobRestServiceInteractionTest extends
	...
	public void testSetJobRetrysNonExistentJob() {
		String expectedMessage = "No job found with id '"
	...
	public void testSetJobRetrysNegativeRetries() {
		...
		String expectedMessage = "The number of job retries must be a non-negative Integer, but '"
