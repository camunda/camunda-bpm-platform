...
public class ProcessEngineRestServiceTest extends AbstractProcessEngineRestServiceTest {
  ...
  public void setUpRuntimeData() {
    ...
    when(mockRepoService.getProcessDefinition(eq(ExampleDataProvider.EXAMPLE_PROCESS_DEFINITION_ID))).thenReturn(mockDefinition);
  ...
  public void testEngineAccess() {
    ...
    verify(mockRepoService).getProcessDefinition(eq(ExampleDataProvider.EXAMPLE_PROCESS_DEFINITION_ID));
