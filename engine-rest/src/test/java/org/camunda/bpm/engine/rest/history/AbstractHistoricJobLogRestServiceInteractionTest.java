 ...
 *
 */
public abstract class AbstractHistoricJobLogRestServiceInteractionTest extends AbstractRestServiceTest {
  ...
  public void testSimpleHistoricJobLogGet() {
    ...
    .then()
      .expect()
        ...
        .body("jobType", equalTo(MockProvider.EXAMPLE_HISTORIC_JOB_LOG_JOB_TYPE))
        .body("jobHandlerType", equalTo(MockProvider.EXAMPLE_HISTORIC_JOB_LOG_JOB_HANDLER_TYPE))
