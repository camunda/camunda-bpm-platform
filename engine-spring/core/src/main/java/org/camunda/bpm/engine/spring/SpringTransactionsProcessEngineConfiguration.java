...
public class SpringTransactionsProcessEngineConfiguration extends ProcessEngineConfigurationImpl {
  ...
  protected Collection< ? extends CommandInterceptor> getDefaultCommandInterceptorsTxRequired() {
    ...
    CommandContextInterceptor commandContextInterceptor = new CommandContextInterceptor(commandContextFactory, commandInvocationContextFactory, this);
  ...
  protected Collection< ? extends CommandInterceptor> getDefaultCommandInterceptorsTxRequiresNew() {
    ...
    CommandContextInterceptor commandContextInterceptor = new CommandContextInterceptor(commandContextFactory, commandInvocationContextFactory, this, true);
