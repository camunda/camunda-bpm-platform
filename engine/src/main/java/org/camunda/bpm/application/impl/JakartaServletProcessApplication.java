 ...
 * {@link JakartaServletProcessApplication} annotated with <code>{@literal @}ProcessApplication</code> to your
 * application:
 * <pre>
 ...
 * <p>The process engine holds a {@link WeakReference} to the {@link JakartaServletProcessApplication} and does not cache any
 ...
 *
 */
public class JakartaServletProcessApplication extends AbstractProcessApplication implements ServletContextListener {
  ...
  protected ClassLoader initProcessApplicationClassloader(ServletContextEvent sce) {
    ...
    if (isServlet30ApiPresent(sce) && getClass().equals(JakartaServletProcessApplication.class)) {
