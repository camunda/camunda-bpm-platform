...
/**
 * Service which provides access to {@link CaseInstance case instances} and {@link CaseExecution
 * case executions}.
 *
...
public interface CaseService {
  ...
  /**
   * <p>
   * Creates a new {@link CaseInstance} of the latest version of the case definition with the given
   * key. The new case instance will be in the <code>ACTIVE</code> state.
   * </p>
   *
   ...
   *           when no case definition is deployed with the given key.
  ...
  /**
   * <p>
   * Creates a new {@link CaseInstance} in the exactly specified version identify by the provided
   ...
   * @throws NotFoundException
   *           when no case definition is deployed with the given id.
   * @throws ProcessEngineException
   *           when an internal exception happens during the execution of the command
   */
  ...
  /**
   * <p>
   * Starts the case execution identified by the given id manually. Performs the transition from
   * state <code>ENABLED</code> to state <code>ACTIVE</code>.
   * </p>
   *
   * <p>
   * According to CMMN 1.0 specification, the state <code>ACTIVE</code> means that the {@link Stage}
   * or {@link Task} related to the case execution does the following:
   * <ul>
   * <li>{@link Task}: the {@link Task task} is completed immediately</li>
   * <li>{@link HumanTask}: a new {@link org.camunda.bpm.engine.task.Task user task} is
   * instantiated</li>
   ...
   * @throws NotFoundException
   *           when no case execution is found for the given case execution id
   * @throws NotAllowedException
   *           when the transition is not allowed to be done or when the case execution is a case
   *           instance
   * @throws ProcessEngineException
   *           when an internal exception happens during the execution of the command.
   */
   ...
   * <code>ENABLED</code> to state <code>DISABLED</code>.
   * </p>
   *
   * <p>
   * According to CMMN 1.0 specification, the state <code>DISABLED</code> means that the
   * {@link Stage} or {@link Task} related to the case execution should not be executed in this case
   * instance.
   * </p>
   *
   * <p>
   * If the given case execution has a parent case execution, that parent case execution will be
   * notified that the given case execution has been disabled. This can lead to a completion of the
   * parent case execution if the completion criteria are fulfilled.
   * </p>
   *
   * @param caseExecutionId
   ...
   * <code>DISABLED</code> to state <code>ENABLED</code>.
   * </p>
   *
   * <p>
   * According to CMMN 1.0 specification, the state <code>DISABLED</code> means that the
   * {@link Stage} or {@link Task} related to the case execution pends for a decision to become
   * <code>ACTIVE</code> or <code>DISABLED</code>.
   * </p>
   *
   * @param caseExecutionId
   ...
   * <code>ACTIVE</code> to state <code>COMPLETED</code>.
   * </p>
   *
   * <p>
   ...
   *
   * <p>
   * In case of a {@link Stage}, the completion can only be performed when the following criteria
   * are fulfilled:<br>
   * <ul>
   ...
   * <p>
   * If the given case execution has a parent case execution, that parent case execution will be
   * notified that the given case execution has been completed. This can lead to a completion of the
   * parent case execution if the completion criteria are fulfilled.
   * </p>
   *
   * @param caseExecutionId
   ...
   *           when no case execution is found for the given case execution id
   * @throws NotAllowedException
   *           when the transition is not allowed to be done
   * @throws ProcessEngineException
   *           when an internal exception happens during the execution of the command.
   */
  ...
  /**
   * <p>
   * Closes the case instance the execution identified by the given id belongs to. Once closed, no
   * further work or modifications are allowed for the case instance. Performs a transition from
   ...
   * <code>ACTIVE</code> to state <code>TERMINATED</code> if the case execution belongs to a case
   * model or a task or a stage. Performs the transition from <code>AVAILABLE</code> to state
   * <code>TERMINATED</code> if the case execution belongs to a milestone.
   * </p>
   *
   * @param caseExecutionId
   ...
   * <p>
   * Terminates the case execution identified by the given id. Performs the transition from
   * <code>ACTIVE</code> to state <code>TERMINATED</code> if the case execution belongs to either a
   * case model or a task or a stage. Performs the transition from <code>AVAILABLE</code> to state
   * <code>TERMINATED</code> if the case execution belongs to a milestone.
   * </p>
   *
   *
   * @param caseExecutionId
   *          the id of the case execution to terminate
   * @param variables
   *          variables to be set on the case execution
   *
   * @throws NotValidException
   ...
   *
   * @return a {@link CaseExecutionCommandBuilder fluent builder} for defining a command for a case
   *         execution
   */
  ...
  /**
   * <p>
   * Creates a new {@link CaseInstanceQuery} instance, that can be used to query case instances.
   * </p>
   */
  ...
  /**
   * <p>
   * Creates a new {@link CaseExecutionQuery} instance, that can be used to query the executions and
   * case instances.
   * </p>
   */
   ...
   *          if false, the process engine will not attempt to deserialize {@link SerializableValue
   *          SerializableValues}.
   *
   * @return the variables or an empty map if no such variables are found
   *
  ...
  /**
   * <p>
   * All variable values that are defined in the case execution scope, without taking outer scopes
   * into account.
   * </p>
   *
   * <p>
   ...
   * visible from the given case execution scope (including parent scopes).
   * </p>
   *
   * @param caseExecutionId
   *          the id of a case instance or case execution, cannot be null
   ...
   *          the collection of variable names that should be retrieved
   * @param deserializeValues
   *          if false, {@link SerializableValue SerializableValues} will not be deserialized
   *
   * @return the variables or an empty map if no such variables are found
   *
   * @throws NotValidException
   ...
   *           when an internal exception happens during the execution of the command
   */
  VariableMap getVariablesTyped(String caseExecutionId, Collection<String> variableNames,
      boolean deserializeValues);

  /**
   * <p>
   * The variable values for the given variableNames only taking the given case execution scope into
   ...
   *           when an internal exception happens during the execution of the command
   */
  VariableMap getVariablesLocalTyped(String caseExecutionId, Collection<String> variableNames,
      boolean deserializeValues);

  /**
   * <p>
   * Searching for the variable is done in all scopes that are visible to the given case execution
   * (including parent scopes).
   * </p>
   *
   * <p>
   * Returns null when no variable value is found with the given name or when the value is set to
   * null.
   * </p>
   *
   * @param caseExecutionId
   ...
   *
   * @throws NotValidException
   *           when the given case execution id or variable name is null
   * @throws NotFoundException
   *           when no case execution is found for the given case execution id
   * @throws ProcessEngineException
   *           when an internal exception happens during the execution of the command
  ...
  /**
   * <p>
   * The variable value for an case execution. Returns the value when the variable is set for the
   * case execution (and not searching parent scopes).
   * </p>
   *
   * <p>
   * Returns null when no variable value is found with the given name or when the value is set to
  ...
  /**
   * <p>
   * Pass a map of variables to the case execution. If the variables do not already exist, they are
   * created in the case instance (which is the root execution). Otherwise existing variables are
   * updated.
   * </p>
   *
   * @param caseExecutionId
   *          the case execution to set the variables for
   * @param variables
  ...
  /**
   * <p>
   * Pass a variable to the case execution. If the variable does not already exist, it is created in
   * the case instance (which is the root execution). Otherwise, the existing variable is updated.
   * </p>
   *
   * @param caseExecutionId
   *          the case execution to set the variable for
   * @param variableName
   ...
   *
   * @param caseExecutionId
   *          the case execution to remove the variables from
   * @param variableNames
  ...
  /**
   * <p>
   * Pass a collection of names identifying local variables to be removed from a case execution (not
   * considering parent scopes).
   * </p>
   *
   * @param caseExecutionId
   *          the case execution to remove the variables from
   ...
   *
   * @param caseExecutionId
   *          the case execution to remove the variable from
   * @param variableName
  ...
  /**
   * <p>
   * Pass a variable name of a local variable to be removed from a case execution (not considering
   * parent scopes).
   * </p>
   *
   * @param caseExecutionId
