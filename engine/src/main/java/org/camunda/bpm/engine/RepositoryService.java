...
public interface RepositoryService {
   ...
   *          id of the deployment, cannot be null.
   * @param cascade
   *          if set to true, all process instances (incuding) history are
   *          deleted
   * @param skipCustomListeners
   *          if true, only the built-in {@link ExecutionListener}s are notified
   *          with the {@link ExecutionListener#EVENTNAME_END} event.
   */
  ...
  /**
   * Retrieves a list of deployment resources for the given deployment, ordered
   ...
   *           when the resource doesn't exist in the given deployment or when
   *           no deployment exists for the given deploymentId.
   */
   ...
   *          null, the process definition is suspended immediately. Note: The
   *          job executor needs to be active to use this!
   * 
   * @throws ProcessEngineException
   *           if no such processDefinition can be found.
   * 
   ...
   * @param suspendProcessInstances
   *          If true, all the process instances of the provided process
   *          definition will be activated too.
  ...
  /**
   * Activates the process definition with the given key (=id in the bpmn20.xml
   * file).
   * 
   * @throws ProcessEngineException
   *           if no such processDefinition can be found.
   ...
   * @param processDefinitionId
   *          id of a {@link ProcessDefinition}, cannot be null.
   * @return null when the diagram resource name of a {@link ProcessDefinition}
   *         is null.
   * @throws ProcessEngineException
   ...
   * @return null when the diagram resource name of a {@link CaseDefinition} is
   *         null.
   * @throws ProcessEngineException
   *           when the process diagram doesn't exist.
   */
   ...
   * 
   * @param processDefinitionId
   *          the id of the Process Definition for which the
   *          {@link BpmnModelInstance} should be retrieved.
   ...
   * 
   * @param caseDefinitionId
   *          the id of the Case Definition for which the
   *          {@link CmmnModelInstance} should be retrieved.
   * 
   * @return the {@link CmmnModelInstance}
   * 
   * @throws NotValidException
   *           when the given case definition id or deployment id or resource
   *           name is null
   * @throws NotFoundException
   *           when no CMMN model instance or deployment resource is found for
   *           the given case definition id
   * @throws ProcessEngineException
   *           when an internal exception happens during the execution of the
   *           command.
   */
  ...
  /**
   * Gives access to a deployed case model, e.g., a CMMN 1.0 XML file, through a
   * stream of bytes.
   * 
   * @param caseDefinitionId
   *          id of a {@link CaseDefinition}, cannot be null.
   ...
   *           name is null
   * @throws NotFoundException
   *           when no case definition or deployment resource is found for the
   *           given case definition id
   * @throws ProcessEngineException
   *           when an internal exception happens during the execution of the
   *           command
   */
