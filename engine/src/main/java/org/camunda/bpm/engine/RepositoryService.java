...
public interface RepositoryService {
   ...
   */
  ProcessApplicationDeploymentBuilder createDeployment(
   ...
   *           {@link Resources#DEPLOYMENT}.
   *
   * @deprecated use {@link #deleteDeployment(String, boolean)}. This methods may be deleted from
   *             5.3.
   */
  @Deprecated
  ...
  /**
   * Deletes the process definition which belongs to the given process definition id. Same behavior
   * as {@link RepositoryService#deleteProcessDefinition(java.lang.String, boolean, boolean)} Both
   * boolean parameters of this method are per default false. The deletion is in this case not
   * cascading.
   *
  ...
  /**
   * Deletes the process definition which belongs to the given process definition id. Cascades the
   * deletion if the cascade is set to true. Same behavior as
   * {@link RepositoryService#deleteProcessDefinition(java.lang.String, boolean, boolean)} The
   * skipCustomListeners parameter is per default false. The custom listeners are called if the
   * cascading flag is set to true and the process instances are deleted.
   *
   * @param processDefinitionId
   *          the id, which corresponds to the process definition
   * @param cascade
  ...
  /**
   * Deletes the process definition which belongs to the given process definition id. Cascades the
   * deletion if the cascade is set to true the custom listener can be skipped if the third
   ...
   * @param skipCustomListeners
   *          if true, only the built-in {@link ExecutionListener}s are notified with the
   *          {@link ExecutionListener#EVENTNAME_END} event. Is only used if cascade set to true.
   *
   * @throws ProcessEngineException
   *           If the process definition does not exist
   *
   ...
   * Deletes the process definition which belongs to the given process definition id. Cascades the
   * deletion if the cascade is set to true, the custom listener can be skipped if the third
   * parameter is set to true, io mappings can be skipped if the forth parameter is set to true.
   *
   * @param processDefinitionId
   *          the id, which corresponds to the process definition
   * @param cascade
  ...
  /**
   * Retrieves a list of deployment resources for the given deployment, ordered alphabetically by
   * name.
   *
   * @param deploymentId
   *          id of the deployment, cannot be null.
   ...
   *           <li>{@link ProcessDefinitionPermissions#SUSPEND} permission on
   *           {@link Resources#PROCESS_DEFINITION}</li>
   *           <li>{@link Permissions#UPDATE} permission on
   *           {@link Resources#PROCESS_DEFINITION}</li>
   */
   ...
   *          If true, all the process instances of the provided process definition will be
   *          suspended too.
   * @param suspensionDate
   *          The date on which the process definition will be suspended. If null, the process
   *          definition is suspended immediately. Note: The job executor needs to be active to use
   *          this!
   *
   * @throws ProcessEngineException
   *           If no such processDefinition can be found.
   ...
   *           {@link Resources#PROCESS_DEFINITION}.</li>
   *           <li>and if <code>suspendProcessInstances</code> is set to <code>true</code> and the
   *           user has none of the following:</li>
   *           <ul>
   ...
   *
   * @throws ProcessEngineException
   *           If no such processDefinition can be found or if the process definition is already in
   *           state active.
   * @throws AuthorizationException
   *           If the user has none of the following:
   *           <li>{@link ProcessDefinitionPermissions#SUSPEND} permission on
   ...
   *          The date on which the process definition will be activated. If null, the process
   *          definition is suspended immediately. Note: The job executor needs to be active to use
   *          this!
   *
   * @throws ProcessEngineException
  ...
  /**
   * Activate or suspend process definitions using a fluent builder. Specify the definitions by
   * calling one of the <i>by</i> methods, like <i>byProcessDefinitionId</i>. To update the
   * suspension state call {@link UpdateProcessDefinitionSuspensionStateBuilder#activate()} or
   ...
   */
  void updateDecisionDefinitionHistoryTimeToLive(String decisionDefinitionId,
      Integer historyTimeToLive);
   ...
   *
   * @param processDefinitionId
   *          the id of the Process Definition for which the {@link BpmnModelInstance} should be
   *          retrieved.
   *
   ...
   *
   * @param caseDefinitionId
   *          the id of the Case Definition for which the {@link CmmnModelInstance} should be
   *          retrieved.
   *
   ...
   *           when no CMMN model instance or deployment resource is found for the given case
   *           definition id
   * @throws ProcessEngineException
   ...
   *
   * @param decisionDefinitionId
   *          the id of the Decision Definition for which the {@link DmnModelInstance} should be
   *          retrieved.
   *
   ...
   * @throws NotFoundException
   *           when no DMN model instance or deployment resource is found for the given decision
   *           definition id
   * @throws ProcessEngineException
   *           when an internal exception happens during the execution of the command.
   * @throws AuthorizationException
   ...
   *           when the given case definition id or deployment id or resource name is null
   * @throws NotFoundException
   *           when no case definition or deployment resource is found for the given case definition
   *           id
   * @throws ProcessEngineException
   *           when an internal exception happens during the execution of the command
   */
   ...
   * @throws NotFoundException
   *           when no decision requirements definition is found for the given decision requirements
   *           definition id
   * @throws ProcessEngineException
   *           when an internal exception happens during the execution of the command.
   * @throws AuthorizationException
   *           If the user has no {@link Permissions#READ} permission on
   *           {@link Resources#DECISION_REQUIREMENTS_DEFINITION}.
   */
   ...
   *           when the given decision definition id or deployment id or resource name is null
   * @throws NotFoundException
   *           when no decision definition or deployment resource is found for the given decision
   *           definition id
   * @throws ProcessEngineException
   *           when an internal exception happens during the execution of the command
   * @throws AuthorizationException
   ...
   *
   * @throws NotValidException
   *           when the given decision requirements definition id or deployment id or resource name
   *           is null
   * @throws NotFoundException
   *           when no decision requirements definition or deployment resource is found for the
   *           given decision requirements definition id
   * @throws ProcessEngineException
   *           when an internal exception happens during the execution of the command
   * @throws AuthorizationException
   *           If the user has no {@link Permissions#READ} permission on
  ...
  /**
   * Gives access to a deployed decision requirements diagram, e.g., a PNG image, through a stream
   * of bytes.
   *
   * @param decisionRequirementsDefinitionId
   *          id of a {@link DecisionRequirementsDefinition}, cannot be null.
   * @return null when the diagram resource name of a {@link DecisionRequirementsDefinition} is
   *         null.
   * @throws ProcessEngineException
