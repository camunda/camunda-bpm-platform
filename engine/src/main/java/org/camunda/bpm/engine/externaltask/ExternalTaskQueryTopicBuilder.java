...
public interface ExternalTaskQueryTopicBuilder extends ExternalTaskQueryBuilder {
  ...
  /**
   * Define variables to fetch with all tasks for the current topic. Calling this method multiple
   * times overrides the previously specified variables.
   *
   * @param variables
  ...
  /**
   * Define a HashMap of variables and their values to filter correlated tasks. Calling this method
   * multiple times overrides the previously specified variables.
   *
   * @param variables
  ...
  /**
   * Define a single variable and its name to filter tasks in a topic. Multiple calls to this method
   * add to the existing "variable filters".
   *
   * @param name
  ...
  /**
   * Enable deserialization of variable values that are custom objects. By default, the query will
   * not attempt to deserialize the value of these variables.
   *
   * @return this builder
   */
