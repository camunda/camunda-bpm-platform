...
public interface HistoricCaseActivityInstanceQuery
  ...
  /**
   * Only select historic case activity instances with the given id (primary key within history
   * tables).
   */
  ...
  /**
   * Only select historic case activity instances that were ended (ie. completed or terminated)
  ...
  /**
   * Only select historic case activity instances which are already ended (ie. completed or
   * terminated).
   */
   ...
   * ordering of historic case activity instances without tenant id is database-specific.
   */
