...
public interface HistoricTaskInstanceReport extends Report {
  ...
  /**
   * <p>
   * Sets the completed after date for constraining the query to search for all tasks which are
   * completed after a certain date.
   * </p>
   *
   * @param completedAfter
   *          A {@link Date} to define the granularity of the report
   *
  ...
  /**
   * <p>
   * Sets the completed before date for constraining the query to search for all tasks which are
  ...
  /**
   * <p>
   * Executes the task report query and returns a list of {@link HistoricTaskInstanceReportResult}s
   * </p>
   *
   * @throws AuthorizationException
   *           If the user has no {@link Permissions#READ_HISTORY} permission on any
