 ...
 */
public interface SetRemovalTimeToHistoricBatchesAsyncBuilder {
   ...
   * @return the builder.
   */
  SetRemovalTimeToHistoricBatchesAsyncBuilder byQuery(HistoricBatchQuery historicBatchQuery);
   ...
   * @return the builder.
   */
  SetRemovalTimeToHistoricBatchesAsyncBuilder absoluteRemovalTime(Date removalTime);
   ...
   * @return the builder.
   */
  SetRemovalTimeToHistoricBatchesAsyncBuilder calculatedRemovalTime();
