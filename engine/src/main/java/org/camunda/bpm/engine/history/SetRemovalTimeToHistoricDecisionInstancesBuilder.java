...
/**
 * Fluent builder to set the removal time to historic decision instances and all associated historic
 * entities.
 *
...
public interface SetRemovalTimeToHistoricDecisionInstancesBuilder {
   ...
   *
   * @param historicDecisionInstanceQuery
   *          to be evaluated.
   * @return the builder.
   */
  SetRemovalTimeToHistoricDecisionInstancesBuilder byQuery(
  ...
  /**
   * Takes additionally historic decision instances into account that are part of the hierarchy of
   * the given historic decision instances.
   *
   * If the root decision instance id of the given historic decision instance is {@code null}, the
   * hierarchy is ignored. This is the case for instances that were started with a version prior
   * 7.10.
   *
   * @return the builder.
   */
   ...
   *           when no historic decision instances could be found.
