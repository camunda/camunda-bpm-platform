...
/**
 * Fluent builder to set the removal time to historic process instances and all associated historic
 * entities.
 *
...
public interface SetRemovalTimeToHistoricProcessInstancesBuilder {
   ...
   * @return the builder.
   */
  SetRemovalTimeToHistoricProcessInstancesBuilder byQuery(
  ...
  /**
   * Takes additionally those historic process instances into account that are part of the hierarchy
   * of the given historic process instance.
   *
   * If the root process instance id of the given historic process instance is {@code null}, the
   ...
   *           when no historic process instances could be found.
