...
public class SetExternalTaskRetriesJobHandler
  ...
  public static final BatchJobDeclaration JOB_DECLARATION = new BatchJobDeclaration(
      Batch.TYPE_SET_EXTERNAL_TASK_RETRIES);
  ...
  public void execute(BatchJobConfiguration configuration, ExecutionEntity execution,
    ...
    try {
      commandContext.getProcessEngineConfiguration().getExternalTaskService()
  ...
  protected SetRetriesBatchConfiguration createJobConfiguration(
      SetRetriesBatchConfiguration configuration, List<String> processIdsForJob) {
