...
public class BpmnBehaviorLogger extends ProcessEngineLogger {
  ...
  public void missingOutgoingSequenceFlow(String activityId) {
    logDebug("003", "No outgoing sequence flow found for activity '{}'. Ending execution.",
        activityId);
  }
  ...
  public ProcessEngineException missingDefaultFlowException(String activityId,
    ...
    return new ProcessEngineException(exceptionMessage("005",
        "Default sequence flow '{}' for element with id '{}' could not be not found.",
  ...
  public ProcessEngineException incorrectlyUsedSignalException(String className) {
    return new ProcessEngineException(
        exceptionMessage("007", "signal() can only be called on a '{}' instance.", className));
  }
  ...
  public ProcessEngineException missingDelegateParentClassException(String className,
    ...
    return new ProcessEngineException(exceptionMessage("008",
        "Class '{}' doesn't implement '{}' nor '{}'.", className, javaDelegate, activityBehavior));
  }

  public void outgoingSequenceFlowSelected(String sequenceFlowId) {
    logDebug("009", "Sequence flow with id '{}' was selected as outgoing sequence flow.",
        sequenceFlowId);
  }

  public ProcessEngineException unsupportedSignalException(String activityId) {
    return new ProcessEngineException(
        exceptionMessage("010", "The activity with id '{}' doesn't accept signals.", activityId));
  }
  ...
  public void ignoringEventSubscription(EventSubscriptionEntity eventSubscription,
  ...
  public ProcessEngineException sendingEmailException(String recipient, Throwable cause) {
    return new ProcessEngineException(
        exceptionMessage("015", "Unable to send email to recipient '{}'.", recipient), cause);
  }

  public ProcessEngineException emailFormatException() {
    return new ProcessEngineException(exceptionMessage("016",
  ...
  public ProcessEngineException emailCreationException(String format, Throwable cause) {
    return new ProcessEngineException(
        exceptionMessage("017", "Unable to create a mail with format '{}'.", format), cause);
  }

  public ProcessEngineException addRecipientException(String recipient, Throwable cause) {
    return new ProcessEngineException(
        exceptionMessage("018", "Unable to add '{}' as recipient.", recipient), cause);
  }

  public ProcessEngineException missingRecipientsException() {
    return new ProcessEngineException(
        exceptionMessage("019", "No recipient could be found for sending email."));
  }

  public ProcessEngineException addSenderException(String sender, Throwable cause) {
    return new ProcessEngineException(
        exceptionMessage("020", "Could not set '{}' as from address in email.", sender), cause);
  }

  public ProcessEngineException addCcException(String cc, Throwable cause) {
    return new ProcessEngineException(
        exceptionMessage("021", "Could not add '{}' as cc recipient.", cc), cause);
  }

  public ProcessEngineException addBccException(String bcc, Throwable cause) {
    return new ProcessEngineException(
        exceptionMessage("022", "Could not add '{}' as bcc recipient.", bcc), cause);
  }
  ...
  public ProcessEngineException invalidAmountException(String type, int amount) {
    return new ProcessEngineException(exceptionMessage("023",
        "Invalid number of '{}': must be positive integer value or zero, but was '{}'.", type,
        amount));
  }
  ...
  public ProcessEngineException invalidVariableTypeException(String variable, String type) {
    return new ProcessEngineException(
        exceptionMessage("025", "Variable '{}' is not from type '{}'.", variable, type));
  }

  public ProcessEngineException resolveCollectionExpressionOrVariableReferenceException() {
    return new ProcessEngineException(
        exceptionMessage("026", "Couldn't resolve collection expression nor variable reference"));
  }

  public ProcessEngineException expressionNotANumberException(String type, String expression) {
    return new ProcessEngineException(exceptionMessage("027",
  ...
  public void activityActivation(String activityId, int joinedExecutions, int availableExecution) {
    logDebug("030", "Element with id '{}' activates. Joined '{}' of '{}' available executions.",
        activityId, joinedExecutions, availableExecution);
  }

  public void noActivityActivation(String activityId, int joinedExecutions,
  ...
  public ProcessEngineException resolveDelegateExpressionException(Expression expression,
    ...
    return new ProcessEngineException(exceptionMessage("033",
        ...
        expression, parentClass, javaDelegateClass));
  }

  public ProcessEngineException shellExecutionException(Throwable cause) {
    return new ProcessEngineException(exceptionMessage("034", "Could not execute shell command."),
        cause);
  }

  public void errorPropagationException(String activityId, Throwable cause) {
    logError("035", "caught an exception while propagate error in activity with id '{}'",
        activityId, cause);
  }
  ...
  public ProcessEngineException missingDelegateVariableMappingParentClassException(String className,
      String delegateVarMapping) {
    return new ProcessEngineException(exceptionMessage("041", "Class '{}' doesn't implement '{}'.",
        className, delegateVarMapping));
  }

  public ProcessEngineException missingBoundaryCatchEventError(String executionId,
      String errorCode) {
