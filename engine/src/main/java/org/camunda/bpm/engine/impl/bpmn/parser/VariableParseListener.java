...
public class VariableParseListener implements BpmnParseListener {

  protected ExecutionListener var = new ActivityInstanceVariableStartListener();

  public VariableParseListener() {
  }

  protected void addListeners(ActivityImpl activity) {
    activity.addBuiltInListener(ExecutionListener.EVENTNAME_START, var);
  }
  ...
  public void parseStartEvent(Element startEventElement, ScopeImpl scope, ActivityImpl startEventActivity) {
    if (startEventActivity.getActivityBehavior() instanceof EventSubProcessStartEventActivityBehavior) {
      addListeners(startEventActivity);
      System.out.println("boom6");
    }
  }
