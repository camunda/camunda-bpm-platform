...
public class ConfigurationLogger extends ProcessEngineLogger {
  ...
  public ProcessEngineException invalidConfigCannotFindTransactionManger(String jndiName,
      NamingException e) {
    return new ProcessEngineException(
        exceptionMessage("002",
            "Cannot lookup instance of Jta Transaction manager in JNDI using name '{}'", jndiName),
        e);
  }
  ...
  public ProcessEngineException invalidConfigDefaultUserPermissionNameForTask(
    ...
    return new ProcessEngineException(exceptionMessage("007",
        "Invalid value '{}' for configuration property 'defaultUserPermissionNameForTask'. Valid values are: '{}'",
  ...
  public ProcessEngineException invalidPropertyValue(String propertyName, String propertyValue,
      String reason) {
    return new ProcessEngineException(
        exceptionMessage("009", "Invalid value '{}' for configuration property '{}': {}.",
            propertyValue, propertyName, reason));
  }

  public void invalidBatchOperation(String operation, String historyTimeToLive) {
    logWarn("010", "Invalid batch operation name '{}' with history time to live set to'{}'",
        operation, historyTimeToLive);
  }
  ...
  public void databaseConnectionAccessException(Exception cause) {
    logError("012", "Exception on accessing the database connection: {}", cause.getMessage());
  }

  public void databaseConnectionCloseException(Exception cause) {
    logError("013", "Exception on closing the database connection: {}", cause.getMessage());
  }
