...
public class DefaultCrdbIntegrationProvider implements CrdbIntegrationProvider {
  ...
  @Override
  public CrdbTransactionRetryInterceptor getCrdbRetryInterceptor(int commandRetries) {
