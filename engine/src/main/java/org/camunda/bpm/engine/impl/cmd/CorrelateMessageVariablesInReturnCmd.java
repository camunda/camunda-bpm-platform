...
public class CorrelateMessageVariablesInReturnCmd extends AbstractCorrelateMessageCmd implements Command<MessageCorrelationResultWithVariables> {
   ...
   */
  public CorrelateMessageVariablesInReturnCmd(MessageCorrelationBuilderImpl messageCorrelationBuilderImpl) {
    super(messageCorrelationBuilderImpl, true);
  }

  public MessageCorrelationResultWithVariables execute(final CommandContext commandContext) {
    ...
    return createMessageCorrelationResultWithVariables(commandContext, correlationResult);
  }
