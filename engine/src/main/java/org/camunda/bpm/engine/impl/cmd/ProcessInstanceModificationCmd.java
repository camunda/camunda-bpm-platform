...
public class ProcessInstanceModificationCmd extends AbstractModificationCmd<Void> {
  ...
  public ProcessInstanceModificationCmd(ModificationBuilderImpl modificationBuilder,
  ...
  public Void execute(final CommandContext commandContext) {
    ...
    for (String processInstanceId : processInstanceIds) {
      ...
      ProcessInstanceModificationBuilderImpl builder = createProcessInstanceModificationBuilder(
          processInstanceId, commandContext);
  ...
  protected ProcessInstanceModificationBuilderImpl createProcessInstanceModificationBuilder(
      final String processInstanceId, final CommandContext commandContext) {
    ProcessInstanceModificationBuilderImpl processInstanceModificationBuilder = new ProcessInstanceModificationBuilderImpl(
        commandContext, processInstanceId);
    List<AbstractProcessInstanceModificationCommand> operations = processInstanceModificationBuilder
    ...
    for (AbstractProcessInstanceModificationCommand instruction : builder.getInstructions()) {
      ...
      if (!(instruction instanceof ActivityCancellationCmd)
        ...
        List<AbstractInstanceCancellationCmd> cmds = cancellationInstruction
            .createActivityInstanceCancellations(activityInstanceTree, commandContext);
