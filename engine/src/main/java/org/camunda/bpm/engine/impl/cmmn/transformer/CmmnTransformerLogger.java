...
public class CmmnTransformerLogger extends ProcessEngineLogger {
  ...
  public ProcessEngineException transformResourceException(String name, Throwable cause) {
    return new ProcessEngineException(
        exceptionMessage("001", "Could not transform resource '{}'.", name), cause);
  }

  public ProcessEngineException parseProcessException(String name, Throwable cause) {
    return new ProcessEngineException(
        exceptionMessage("002", "Error while parsing process of resource '{}'.", name), cause);
  }
  ...
  public void ignoredSentryWithInvalidParts(String id) {
    logInfo("004",
        "Sentry with id '{}' will be ignored. Reason: ifPart and all onParts are not valid.", id);
  }
  ...
  public void multipleIgnoredConditions(String id) {
    logInfo("006", "The ifPart of the sentry with id '{}' has more than one condition. "
  ...
  public CmmnTransformException nonMatchingVariableEvents(String id) {
    return new CmmnTransformException(exceptionMessage("007",
        "The variableOnPart of the sentry with id '{}' must have one valid variable event. ", id));
  }

  public CmmnTransformException emptyVariableName(String id) {
    return new CmmnTransformException(exceptionMessage("008",
        "The variableOnPart of the sentry with id '{}' must have variable name. ", id));
  }
}
