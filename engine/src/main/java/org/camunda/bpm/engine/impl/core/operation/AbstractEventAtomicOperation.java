...
public abstract class AbstractEventAtomicOperation<T extends CoreExecution>
  ...
  public void execute(T execution) {
    ...
    List<DelegateListener<? extends BaseDelegateExecution>> listeners = getListeners(scope,
        execution);
  ...
  protected List<DelegateListener<? extends BaseDelegateExecution>> getListeners(
