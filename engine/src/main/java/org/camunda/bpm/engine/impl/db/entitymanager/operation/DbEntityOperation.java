...
public class DbEntityOperation extends DbOperation {
  ...
  /**
   * Returns true if the provided operation deletes the entity this operation attemps to INSERT or UPDATE
   *
   * @param operation the operation to check
   * @return true if the provided operation deletes the entity this operation attemps to INSERT or UPDATE
   */
  public boolean isDeletedBy(DbEntityOperation operation) {
    return
      operation.operationType == DbOperationType.DELETE
      // if executed on the same entity
      && this.getEntityType().equals(operation.getEntityType())
      && this.entity.getId().equals(operation.entity.getId());
  }
