 ...
 *
 */
public class DbOperation implements Recyclable {
  ...
  /**
   * Returns true if both opertations are the same
   *
   * @param operation
   * @return true if both opertations are the same
   */
  public boolean isSameOperationAs(DbOperation operation) {
