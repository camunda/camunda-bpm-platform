...
/**
 * Orders operations such that inserts come first
 *
 * @author Daniel Meyer
 *
 */
public class DbOperationTypeOrder implements DbOperationComparator<DbOperation> {
  ...
  public int compare(DbOperation firstOperation, DbOperation secondOperation) {
    ...
    Integer firstOp = firstOperationType == DbOperationType.INSERT ? 0 : 1;
    Integer secondOp = secondOperationType == DbOperationType.INSERT ? 0 : 1;
