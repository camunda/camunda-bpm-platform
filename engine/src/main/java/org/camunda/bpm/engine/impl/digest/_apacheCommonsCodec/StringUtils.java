 ...
 * encodings are specified in
 * <a href="http://java.sun.com/j2se/1.4.2/docs/api/java/nio/charset/Charset.html">Standard
 * charsets</a>
 *
 * @see <a href=
 *      "http://commons.apache.org/proper/commons-codec/apidocs/org/apache/commons/codec/CharEncoding.html">CharEncoding</a>
...
public class StringUtils {
   ...
   * {@link IllegalStateException}, which should never happen for a required charset name. Use this
