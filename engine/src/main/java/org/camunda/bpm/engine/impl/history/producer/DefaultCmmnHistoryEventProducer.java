...
public class DefaultCmmnHistoryEventProducer implements CmmnHistoryEventProducer {
  ...
  public HistoryEvent createCaseActivityInstanceCreateEvt(DelegateCaseExecution caseExecution) {
    ...
    // initialize event
    initCaseActivityInstanceEvent(evt, caseExecutionEntity,
        HistoryEventTypes.CASE_ACTIVITY_INSTANCE_CREATE);
  ...
  public HistoryEvent createCaseActivityInstanceUpdateEvt(DelegateCaseExecution caseExecution) {
    ...
    // create event instance
    HistoricCaseActivityInstanceEventEntity evt = loadCaseActivityInstanceEventEntity(
        caseExecutionEntity);

    // initialize event
    initCaseActivityInstanceEvent(evt, caseExecutionEntity,
        HistoryEventTypes.CASE_ACTIVITY_INSTANCE_UPDATE);
  ...
  public HistoryEvent createCaseActivityInstanceEndEvt(DelegateCaseExecution caseExecution) {
    ...
    // initialize event
    initCaseActivityInstanceEvent(evt, caseExecutionEntity,
        HistoryEventTypes.CASE_ACTIVITY_INSTANCE_END);
  ...
  protected HistoricCaseInstanceEventEntity newCaseInstanceEventEntity(
