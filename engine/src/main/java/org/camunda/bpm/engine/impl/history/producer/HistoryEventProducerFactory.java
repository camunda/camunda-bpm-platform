 ...
 * allows customizing the producers for {@link HistoryEvent HistoryEvents}. This
 * factory allows you to customize the data acquisition aspect of the history
...
public class HistoryEventProducerFactory {
   ...
   *         {@link HistoricProcessInstanceEventEntity} when a process instance
   *         is <b>started</b>.
   */
  ...
  /**
   * @return the {@link HistoryEventProducer} to be invoked for producing the
   *         {@link HistoricActivityInstanceEventEntity} when an activity
