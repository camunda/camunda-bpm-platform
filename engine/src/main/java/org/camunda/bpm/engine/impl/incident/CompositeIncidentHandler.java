...
/**
 * <p>
 * An composite incident handler that handle incidents of a certain type by the multiple handlers.
...
public class CompositeIncidentHandler implements IncidentHandler {
     ...
     * the incident.
     *
     * @param mainIncidentHandler
     *          the main incident handler {@link IncidentHandler} that consume the incident and return result.
     * @param incidentHandlers
     *          the list of {@link IncidentHandler} that consume the incident.
     */
    public CompositeIncidentHandler(
    ...
    public CompositeIncidentHandler(
            IncidentHandler mainIncidentHandler,
            final IncidentHandler... incidentHandlers
    ) {
     ...
     * @param incidentHandlers
     */
    private void initializeIncidentsHandlers(
            IncidentHandler mainIncidentHandler,
            final List<IncidentHandler> incidentHandlers
    ) {
     ...
     *
     * @param incidentHandler
     *          the {@link IncidentHandler} that consume the incident.
     */
