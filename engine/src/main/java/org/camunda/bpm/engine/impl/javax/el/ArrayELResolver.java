...
public class ArrayELResolver extends ELResolver {
   ...
   * accepts for the property argument. Otherwise, returns null. Assuming the base is an array, this
   * method will always return Integer.class. This is because arrays accept integers for their
   * index.
   * 
   * @param context
   *          The context of this evaluation.
   * @param base
   *          The array to analyze. Only bases that are a Java language array are handled by this
   *          resolver.
   ...
   * set to true by this resolver, before returning. If this property is not true after this method
   * is called, the caller should ignore the return value. Assuming the base is an array, this
   * method will always return base.getClass().getComponentType(), which is the most general type of
  ...
  /**
   * If the base object is a Java language array, returns the value at the given index. The index is
   * specified by the property argument, and coerced into an integer. If the coercion could not be
   * performed, an IllegalArgumentException is thrown. If the index is out of bounds, null is
   * returned. If the base is a Java language array, the propertyResolved property of the ELContext
   ...
   * caller should ignore the return value. If this resolver was constructed in read-only mode, this
   * method will always return true. Otherwise, it returns false.
   * 
   * @param context
   *          The context of this evaluation.
   * @param base
   ...
   *         setValue method will always fail or false if it is possible that such a call may
  ...
  /**
   * If the base object is a Java language array, attempts to set the value at the given index with
   * the given value. The index is specified by the property argument, and coerced into an integer.
   * If the coercion could not be performed, an IllegalArgumentException is thrown. If the index is
   * out of bounds, a PropertyNotFoundException is thrown. If the base is a Java language array, the
   * propertyResolved property of the ELContext object must be set to true by this resolver, before
   * returning. If this property is not true after this method is called, the caller can safely
   * assume no value was set. If this resolver was constructed in read-only mode, this method will
