...
public class CompositeELResolver extends ELResolver {
   ...
   * base object. One use for this method is to assist tools in auto-completion. The results are
   * collected from all component resolvers. The propertyResolved property of the ELContext is not
   * relevant to this method. The results of all ELResolvers are concatenated. The Iterator returned
   * is an iterator over the collection of FeatureDescriptor objects returned by the iterators
   * returned by each component resolver's getFeatureDescriptors method. If null is returned by a
   * resolver, it is skipped.
   * 
   * @param context
   *          The context of this evaluation.
   * @param base
   ...
   * {@link #setValue(ELContext, Object, Object, Object)} method. The result is obtained by querying
   * all component resolvers. If this resolver handles the given (base, property) pair, the
   ...
   * the return value. First, propertyResolved is set to false on the provided ELContext. Next, for
   ...
   * returned and the propertyResolved flag remains set to false. Any exception thrown by component
   ...
   * by querying all component resolvers. If this resolver handles the given (base, property) pair,
  ...
  /**
   * Attempts to set the value of the given property object on the given base object. All component
   * resolvers are asked to attempt to set the value. If this resolver handles the given (base,
   * property) pair, the propertyResolved property of the ELContext object must be set to true by
   * the resolver, before returning. If this property is not true after this method is called, the
   * caller can safely assume no value has been set. First, propertyResolved is set to false on the
   ...
   * flag remains set to false. Any exception thrown by component resolvers during the iteration is
   ...
   * 
   * <p>
   * Any exception thrown by component resolvers during the iteration is propagated to the caller of
   * this method.
   * </p>
   * 
   * @param context
   ...
   * @param method
   *          The simple name of the method to invoke. Will be coerced to a <code>String</code>. If
   *          method is "&lt;init&gt;"or "&lt;clinit&gt;" a NoSuchMethodException is raised.
   * @param paramTypes
