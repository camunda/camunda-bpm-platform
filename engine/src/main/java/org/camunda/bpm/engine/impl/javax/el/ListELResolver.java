...
public class ListELResolver extends ELResolver {
   ...
   * this method must return true. Unfortunately, there is no Collections API method to detect this.
   ...
   *           if this resolver was constructed in read-only mode, or if the set operation is not
   *           supported by the underlying list.
   * @throws IllegalArgumentException
   *           if the property could not be coerced into an integer.
   * @throws NullPointerException
   *           if context is null
