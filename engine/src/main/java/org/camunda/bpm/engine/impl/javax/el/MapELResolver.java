...
public class MapELResolver extends ELResolver {
   ...
   * <ul>
   * <li>displayName - The return value of calling the toString method on this key, or "null" if the
   * key is null</li>
   ...
   * <ul>
   * <li>{@link ELResolver#TYPE} - The return value of calling the getClass() method on this key, or
   * null if the key is null.</li>
   ...
   *           underlying Map).
   * @throws NullPointerException
   *           if context is null, or if the key is null and this map does not permit null keys (the
   ...
   *           if this resolver was constructed in read-only mode, or if the put operation is not
