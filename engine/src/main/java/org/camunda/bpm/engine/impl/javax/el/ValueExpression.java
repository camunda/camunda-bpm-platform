...
public abstract class ValueExpression extends Expression {
  ...
  /**
   * Evaluates the expression relative to the provided context, and returns the resulting value. The
   * resulting value is automatically coerced to the type returned by getExpectedType(), which was
  ...
  /**
   * Evaluates the expression relative to the provided context, and sets the result to the provided
   * value.
   * 
   * @param context
   *          The context of this evaluation.
   ...
   *           if the final variable or property resolution failed because the specified variable or
