...
public class Builder implements TreeBuilder {
  ...
  public static enum Feature {
     ...
     * release 2. The method to be invoked is resolved at evaluation time by calling
     ...
     * <code>null</code> if <code>key</code> evaluates to <code>null</code>. Enabling this feature
     * will allow <em>JUEL</em> to pass <code>null</code> to the property resolvers just like any
  ...
  public Tree build(String expression) throws TreeBuilderException {
    try {
      ...
      throw new TreeBuilderException(expression, e.position, e.encountered, e.expected,
          e.getMessage());
