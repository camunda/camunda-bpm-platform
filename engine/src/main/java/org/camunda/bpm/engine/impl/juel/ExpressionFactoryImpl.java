 ...
 * <ol>
 * <li>If the file <code>JAVA_HOME/lib/el.properties</code> exists and if it contains property
 ...
 * </li>
 * <li><code>el.properties</code> on your classpath. These properties override the properties from
 ...
 * <li><code>javax.el.varArgs</code> - support function/method calls using varargs (boolean, default
...
public class ExpressionFactoryImpl extends org.camunda.bpm.engine.impl.javax.el.ExpressionFactory {
   ...
   * A profile can be adjusted using the <code>javax.el.methodInvocations</code>,
   ...
   * above). The maximum cache size will be 1000 unless overridden in <code>el.properties</code>.
   * 
   * @param profile
   ...
   * 1000 unless overridden by property <code>javax.el.cacheSize</code>. The builder profile is
   ...
   * size will be 1000 unless overridden by property <code>javax.el.cacheSize</code>.
   * 
   * @param profile
  ...
  private boolean getFeatureProperty(Profile profile, Properties properties, Feature feature,
      String property) {
    return Boolean
        .valueOf(properties.getProperty(property, String.valueOf(profile.contains(feature))));
  }
   ...
   * <code>javax.el.cacheSize</code>.
   */
  protected TreeStore createTreeStore(int defaultCacheSize, Profile profile,
    ...
    if (properties == null) {
      ...
      if (getFeatureProperty(profile, properties, Feature.METHOD_INVOCATIONS,
   ...
   * <code>de.odysseus.el.misc.TypeConverter</code> property as the name of a class implementing the
   * <code>de.odysseus.el.misc.TypeConverter</code> interface. If the property is not set, the
   ...
   * <code>de.odysseus.el.tree.impl.Builder</code> is used. If the configured class is a subclass of
   * <code>de.odysseus.el.tree.impl.Builder</code> and which provides a constructor taking an array
   * of <code>Builder.Feature</code>, this constructor will be invoked. Otherwise, the default
  ...
  @Override
  public final TreeValueExpression createValueExpression(ELContext context, String expression,
      Class<?> expectedType) {
    return new TreeValueExpression(store, context.getFunctionMapper(), context.getVariableMapper(),
        converter, expression, expectedType);
  }

  @Override
  public final TreeMethodExpression createMethodExpression(ELContext context, String expression,
      Class<?> expectedReturnType, Class<?>[] expectedParamTypes) {
    return new TreeMethodExpression(store, context.getFunctionMapper(), context.getVariableMapper(),
        converter, expression, expectedReturnType, expectedParamTypes);
  }
}
