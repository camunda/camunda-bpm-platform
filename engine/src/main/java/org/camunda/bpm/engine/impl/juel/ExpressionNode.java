...
public interface ExpressionNode extends Node {
   ...
   */
  public MethodInfo getMethodInfo(Bindings bindings, ELContext context, Class<?> returnType,
      Class<?>[] paramTypes);
   ...
   */
  public Object invoke(Bindings bindings, ELContext context, Class<?> returnType,
      Class<?>[] paramTypes, Object[] paramValues);

  /**
   * Get the canonical expression string for this node. Variable and funtion names will be replaced
   * in a way such that two expression nodes that have the same node structure and bindings will
   * also answer the same value here.
   * <p/>
