...
public final class TreeMethodExpression
    extends org.camunda.bpm.engine.impl.javax.el.MethodExpression {
  ...
  /**
   * Create a new method expression. The expression must be an lvalue expression or literal text.
   * The expected return type may be <code>null</code>, meaning "don't care". If it is an lvalue
   * expression, the parameter types must not be <code>null</code>. If it is literal text, the
   * expected return type must not be <code>void</code>.
   * 
   * @param store
