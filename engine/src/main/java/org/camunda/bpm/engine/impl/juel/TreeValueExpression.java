...
public final class TreeValueExpression
    extends org.camunda.bpm.engine.impl.javax.el.ValueExpression {
   ...
   *          <code>base[property]</code>) and to determine the result from the last base/property
   *          pair
   ...
   * @param context
   *          used to resolve properties (<code>base.property</code> and
   *          <code>base[property]</code>) and to perform the assignment to the last base/property
   *          pair
   * @throws ELException
