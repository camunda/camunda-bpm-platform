...
/**
 * Sample of counter values
 */
public class CounterMetricSampleFamily extends MetricSampleFamily {

  public CounterMetricSampleFamily(String name, List<String> labelNames) {
    super(name, TYPE.COUNTER, "", labelNames);
  }
