 ...
 *
 */
public class ProcessElementInstanceMigrator {

  protected ScopeInstantiationStrategy scopeInstantiationStrategy;

  public ProcessElementInstanceMigrator(ScopeInstantiationStrategy scopeInstantiationStrategy) {
    this.scopeInstantiationStrategy = scopeInstantiationStrategy;
  }
  ...
  protected void migrateProcessElementInstance(MigratingProcessElementInstance migratingInstance, MigratingScopeInstanceBranch migratingInstanceBranch) {
    ...
    if (sourceScope != sourceScope.getProcessDefinition() && targetFlowScope != parentActivityInstanceTargetScope) {
      ...
      scopeInstantiationStrategy.instantiateScopes(ancestorScopeInstance, migratingInstanceBranch, nonExistingScopes);
  ...
  public static interface ScopeInstantiationStrategy {
    void instantiateScopes(
