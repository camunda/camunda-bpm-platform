...
public class AuthorizationEntity
  ...
  protected void resetPermissions() {
    ...
    if (authorizationType == AUTH_TYPE_GLOBAL) {
      ...
      throw LOG.engineAuthorizationTypeException(authorizationType, AUTH_TYPE_GLOBAL,
          AUTH_TYPE_GRANT, AUTH_TYPE_REVOKE);
    }
  }
  ...
  public Permission[] getPermissions(Permission[] permissions) {
    ...
    for (Permission permission : permissions) {
      ...
      } else if (AUTH_TYPE_REVOKE == authorizationType && isPermissionRevoked(permission)) {
  ...
  public String toString() {
    return this.getClass().getSimpleName() + "[id=" + id + ", revision=" + revision
        + ", authorizationType=" + authorizationType + ", permissions=" + permissions + ", userId="
        + userId + ", groupId=" + groupId + ", resourceType=" + resourceType + ", resourceId="
        + resourceId + "]";
  }
}
