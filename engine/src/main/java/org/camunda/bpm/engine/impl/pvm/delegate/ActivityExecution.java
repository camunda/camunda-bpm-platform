...
public interface ActivityExecution extends DelegateExecution {
   ...
   *
   * <p>
   * <code>This</code> execution will be the super execution of the created sub case instance.
   * </p>
   *
  ...
  /**
   * returns the list of execution of which this execution the parent of. This is a copy of the
   * actual list, so a modification has no direct effect.
   */
  ...
  /**
   * Takes the given outgoing transitions, and potentially reusing the given list of executions that
  ...
  /**
   * Called when an execution is interrupted. This will remove all associated entities such as event
   * subscriptions, jobs, ...
   */
  ...
  /**
   * Assumption: the current execution is active and executing an activity ({@link #getActivity()}
   * is not null).
   *
  ...
  /**
   * Returns a mapping from scope activities to scope executions for all scopes that are ancestors
   * of the activity currently executed by this execution.
   *
   * Assumption: the current execution is active and executing an activity ({@link #getActivity()}
   * is not null).
   */
