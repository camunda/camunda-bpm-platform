...
public interface ScriptEnvResolver {
   ...
   *
   * @param the
   *          script language to resolve env scripts for.
   * @return an array of environment script sources or null if this resolver does not provide any
   *         scripts for the given language
   */
