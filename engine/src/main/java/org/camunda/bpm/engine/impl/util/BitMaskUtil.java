 ...
 *
 * Currently, only 8-bits are supporten, but can be extended to use all 31 bits in the integer (1st
...
public class BitMaskUtil {
  ...
  private static int[] MASKS = { FLAG_BIT_1, FLAG_BIT_2, FLAG_BIT_3, FLAG_BIT_4, FLAG_BIT_5,
