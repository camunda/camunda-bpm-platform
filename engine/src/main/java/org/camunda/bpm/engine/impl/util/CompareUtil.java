...
public class CompareUtil {
   ...
   * {@link CompareUtil#areNotInAscendingOrder(Comparable[] values)} will return {@code true}
   *
   * @param values
   *          to validate
   * @param <T>
   *          the type of the comparable
   * @return {@code false} if the not null values are in an ascending order or all the values are
   ...
   *
   * E.g. if we have {@code minPriority = 10}, {@code priority = 13} and {@code maxPriority = 5} and
   * {@code List<Integer> values = {minPriority, priority, maxPriority}}. Then a call to
   * {@link CompareUtil#areNotInAscendingOrder(List values)} will return {@code true}
   *
   * @param values
   *          to validate
   * @param <T>
  ...
  /**
   * Checks if the element is not contained within the list of values. If the element, or the list
   * are null then true is returned.
   *
   * @param element
   *          to check
   * @param values
   ...
   * @return {@code true} if the element and values are not {@code null} and the values does not
   *         contain the element, {@code false} otherwise
   */
  ...
  /**
   * Checks if the element is contained within the list of values. If the element, or the list are
   ...
   * @param <T>
   *          the type of the element
   * @return {@code true} if the element and values are not {@code null} and the values contain the
