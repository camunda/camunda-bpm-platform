...
public abstract class ModificationUtil {
  ...
  public static void handleChildRemovalInScope(ExecutionEntity removedExecution) {
    ...
    PvmExecutionImpl executionInParentScope = removedExecution.isConcurrent() ? removedExecution
        : removedExecution.getParent();
    ...
    if (flowScope.getActivityBehavior() != null
      ...
      ModificationObserverBehavior behavior = (ModificationObserverBehavior) flowScope
          .getActivityBehavior();
