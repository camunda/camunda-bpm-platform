...
public final class ScriptUtil {
   ...
   * sources and resources. Dynamic means that the source or resource is an expression which will be
   * evaluated during execution.
   *
   * @param language
   *          the language of the script
   * @param source
   *          the source code of the script or an expression which evaluates to the source code
   * @param resource
   *          the resource path of the script code or an expression which evaluates to the resource
   *          path
   * @param expressionManager
   *          the expression manager to use to generate the expressions of dynamic scripts
   ...
   *          the expression manager to use to generate the expressions of dynamic scripts
   * @param scriptFactory
   *          the script factory used to create the script
   * @return the newly created script
   * @throws NotValidException
  ...
  public static ExecutableScript getScript(String language, String source, String resource,
    ...
    ensureAtLeastOneNotNull(NotValidException.class, "No script source or resource was given",
        source, resource);
   ...
   *           if language is null or empty or source is null
   */
  public static ExecutableScript getScriptFromSource(String language, String source,
  ...
  /**
   * Creates a new {@link ExecutableScript} from a dynamic source. Dynamic means that the source is
   * an expression which will be evaluated during execution.
   *
   * @param language
   *          the language of the script
   ...
   */
  public static ExecutableScript getScriptFromSourceExpression(String language,
   ...
   * resources. Dynamic means that the resource is an expression which will be evaluated during
   * execution.
   *
   * @param language
   *          the language of the script
   ...
   *          the language of the script
   * @param resource
   *          the resource path of the script code
   * @param scriptFactory
   *          the script factory used to create the script
   * @return the newly created script
   * @throws NotValidException
  ...
  public static ExecutableScript getScriptFromResourceExpression(String language,
      Expression resourceExpression, ScriptFactory scriptFactory) {
    ensureNotEmpty(NotValidException.class, "Script language", language);
   ...
   * @param value
   *          the value to check
   * @return true if the value is an expression for a dynamic script source/resource, otherwise
   *         false
   */
  public static boolean isDynamicScriptExpression(String language, String value) {
    return StringUtil.isExpression(value)
        && (language != null && !JuelScriptEngineFactory.names.contains(language.toLowerCase()));
  }
