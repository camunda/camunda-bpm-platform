 ...
 */
public class JakartaEntityManagerSessionFactory implements SessionFactory {

  protected EntityManagerFactory entityManagerFactory;
  protected boolean handleTransactions;
  protected boolean closeEntityManager;

  public JakartaEntityManagerSessionFactory(Object entityManagerFactory, boolean handleTransactions, boolean closeEntityManager) {
  ...
  public Session openSession() {
    return new JakartaEntityManagerSessionImpl(entityManagerFactory, handleTransactions, closeEntityManager);
  }
