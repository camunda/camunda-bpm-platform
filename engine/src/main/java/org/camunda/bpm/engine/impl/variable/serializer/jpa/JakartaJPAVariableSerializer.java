 ...
 * @author Daniel Meyer
 */
public class JakartaJPAVariableSerializer extends AbstractTypedValueSerializer<ObjectValue> {

  public static final String NAME = "jpa";

  private JakartaJPAEntityMappings mappings;

  public JakartaJPAVariableSerializer() {
    super(ValueType.OBJECT);
    mappings = new JakartaJPAEntityMappings();
  }
  ...
  public void writeValue(ObjectValue objectValue, ValueFields valueFields) {
    JakartaEntityManagerSession entityManagerSession = Context
      .getCommandContext()
      .getSession(JakartaEntityManagerSession.class);
    if (entityManagerSession == null) {
      throw new ProcessEngineException("Cannot set JPA variable: " + JakartaEntityManagerSession.class + " not configured");
    } else {
