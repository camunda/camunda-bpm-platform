...
public interface SetJobRetriesAsyncBuilder {
   ...
   * job can be adjusted.
   *
   * @param dueDate The new due date for the updated jobs. If it is null, the retries of the jobs will be updated but the due date is ignored. Can not be null if
