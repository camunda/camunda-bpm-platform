...
public interface DecisionRequirementsDefinitionQuery
   ...
   */
  DecisionRequirementsDefinitionQuery decisionRequirementsDefinitionCategoryLike(
      String categoryLike);
  ...
  /**
   * Only select decision requirements definition where the name matches the given parameter. The
   * syntax that should be used is the same as in SQL, e.g., %name%.
   *
   * @param nameLike
  ...
  /**
   * Only select decision requirements definition where the key matches the given parameter. The
   * syntax that should be used is the same as in SQL, e.g., %key%.
   *
   * @param keyLike
  ...
  /**
   * Only select decision requirements definition that are deployed in a deployment with the given
   * deployment id.
   *
   * @param deploymentId
  ...
  /**
   * Only select decision requirements definition with a certain version. Particularly useful when
   * used in combination with {@link #decisionRequirementsDefinitionKey(String)}
   *
   * @param version
  ...
  /**
   * Only select the decision requirements definition which are the latest deployed (i.e. which have
   * the highest version number for the given key).
   *
   * Can only be used in combination with {@link #decisionRequirementsDefinitionKey(String)} or
   * {@link #decisionRequirementsDefinitionKeyLike(String)}. Can also be used without any other
   * criteria (i.e. query.latest().list()), which will then give all the latest versions of all the
   ...
   */
  DecisionRequirementsDefinitionQuery decisionRequirementsDefinitionResourceName(
      String resourceName);

  /**
   * Only select decision requirements definition with a resource name like the given. The syntax
   * that should be used is the same as in SQL, e.g., %resourceName%.
   *
   * @param resourceNameLike
   *          the pattern to match the resource name
   */
  DecisionRequirementsDefinitionQuery decisionRequirementsDefinitionResourceNameLike(
  ...
  /**
   * Select decision requirements definition which have no tenant id. Can be used in combination
  ...
  /**
   * Order by the id of the decision requirements definition (needs to be followed by {@link #asc()}
   * or {@link #desc()}).
   */
   ...
   * ordering of decision requirements definition without tenant id is database-specific.
   */
