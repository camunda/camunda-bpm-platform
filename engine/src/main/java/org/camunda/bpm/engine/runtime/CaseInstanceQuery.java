...
public interface CaseInstanceQuery extends Query<CaseInstanceQuery, CaseInstance> {
  ...
  /**
   * Select the case instance that has as sub process instance the given process instance. Note that
   * there will always be at most <b>one</b> such case instance that can be the result of this
   * query.
   *
   * @since 7.3
   */
  ...
  /**
   * Select the case instance that has as sub case instance the given case instance. Note that there
   * will always be at most <b>one</b> such process instance that can be the result of this query.
   *
   * @since 7.3
   */
  ...
  /**
   * Only select cases instances which have a global variable with the given value. The type of
  ...
  /**
   * Only select cases instances which have a global variable with the given name, but with a
  ...
  /**
   * Only select cases instances which have a global variable value greater than or equal to the
   * passed value.
   *
   * Booleans, Byte-arrays and {@link Serializable} objects (which are not primitive type wrappers)
   * are not supported.
  ...
  /**
   * Only select cases instances which have a global variable value less than or equal to the passed
   * value.
   *
   * Booleans, Byte-arrays and {@link Serializable} objects (which are not primitive type wrappers)
   * are not supported.
  ...
  /**
   * Only select cases instances which have a global variable value like the given value. This can
