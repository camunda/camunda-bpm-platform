...
public interface InstantiationBuilder<T extends InstantiationBuilder<T>> {
   ...
   * In particular:
   * <ul>
   * <li>In the parent activity hierarchy, determine the closest existing ancestor activity
   * instance</li>
  ...
  /**
   * Submits an instruction that behaves like {@link #startTransition(String)} and always
