...
public interface UpdateProcessInstanceSuspensionStateBuilder {
   ...
   * @return the builder
   */
  UpdateProcessInstanceSuspensionStateBuilder byProcessDefinitionKey(String processDefinitionKey);
   ...
   * @return the builder
   */
  UpdateProcessInstanceSuspensionStateBuilder processDefinitionWithoutTenantId();
   ...
   * @return the builder
   */
  UpdateProcessInstanceSuspensionStateBuilder processDefinitionTenantId(String tenantId);
