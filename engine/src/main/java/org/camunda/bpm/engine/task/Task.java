...
public interface Task {
  ...
  /**
   * The {@link User#getId() userId} of the person that is responsible for this task. This is used
   * when a task is {@link TaskService#delegateTask(String, String) delegated}.
   */
  String getOwner();
   ...
   *
   * <p>
   * <strong>NOTE:</strong> If the task instance us obtained through a query, this property is only
   * populated in case the {@link TaskQuery#initializeFormKeys()} method is called. If this method
   * is called without a prior call to {@link TaskQuery#initializeFormKeys()}, it will throw a
   * {@link BadUserRequestException}.
   * </p>
   *
