...
-- labels
label on index ACT_IDX_CASE_EXEC_CASE is 'ACT_IDX_CASE_EXEC_CASE';
label on index ACT_IDX_CASE_EXEC_PARENT is 'ACT_IDX_CASE_EXEC_PARENT';
label on index ACT_IDX_VARIABLE_CASE_EXEC is 'ACT_IDX_VARIABLE_CASE_EXEC';
label on index ACT_IDX_VARIABLE_CASE_INST is 'ACT_IDX_VARIABLE_CASE_INST';
label on index ACT_IDX_TASK_CASE_EXEC is 'ACT_IDX_TASK_CASE_EXEC';
label on index ACT_IDX_TASK_CASE_DEF_ID is 'ACT_IDX_TASK_CASE_DEF_ID';
label on index ACT_IDX_CASE_SENTRY_CASE_INST is 'ACT_IDX_CASE_SENTRY_CASE_INST';
label on index ACT_IDX_CASE_SENTRY_CASE_EXEC is 'ACT_IDX_CASE_SENTRY_CASE_EXEC';
label on index ACT_IDX_CASE_DEF_TENANT_ID is 'ACT_IDX_CASE_DEF_TENANT_ID';
label on index ACT_IDX_CASE_EXEC_TENANT_ID is 'ACT_IDX_CASE_EXEC_TENANT_ID';
label on table ACT_RE_CASE_DEF is 'ACT_RE_CASE_DEF';
label on table ACT_RU_CASE_EXECUTION is 'ACT_RU_CASE_EXECUTION';
label on table ACT_RU_CASE_SENTRY_PART is 'ACT_RU_CASE_SENTRY_PART';
label on index ACT_IDX_CASE_EXEC_BUSKEY is 'ACT_IDX_CASE_EXEC_BUSKEY';
