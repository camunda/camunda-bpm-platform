...
-- labels
label on table ACT_RE_DECISION_DEF is 'ACT_RE_DECISION_DEF';
label on table ACT_RE_DECISION_REQ_DEF is 'ACT_RE_DECISION_REQ_DEF';
label on index ACT_IDX_DEC_DEF_TENANT_ID is 'ACT_IDX_DEC_DEF_TENANT_ID';
label on index ACT_IDX_DEC_DEF_REQ_ID is 'ACT_IDX_DEC_DEF_REQ_ID';
label on index ACT_IDX_DEC_REQ_DEF_TENANT_ID is 'ACT_IDX_DEC_REQ_DEF_TENANT_ID';
