...
public class SingleProcessInstanceModificationAsyncAuthorizationTest extends AuthorizationTest {
  ...
  public void testModificationWithAllPermissions() {
    // given
    createGrantAuthorization(PROCESS_DEFINITION, "parallelGateway", userId, CREATE_INSTANCE,
        READ_INSTANCE, UPDATE_INSTANCE);
  ...
  public void testModificationWithoutBatchPermissions() {
    ...
    try {
      ...
      assertTrue(e.getMessage()
          .contains("'CREATE_BATCH_MODIFY_PROCESS_INSTANCES' permission on resource 'Batch'"));
    }
  }
