...
public class CaseServiceTest extends PluggableProcessEngineTestCase {
  ...
  public void testExecuteSetVariable() {
    ...
    caseService.withCaseExecution(caseExecutionId).setVariable("aVariableName", "abc")
        .setVariable("anotherVariableName", 999).execute();
  ...
  public void testExecuteSetVariableTyped() {
    ...
    // when
    caseService.withCaseExecution(caseExecutionId).setVariable("aVariableName", stringValue("abc"))
        .setVariable("anotherVariableName", integerValue(null)).execute();
  ...
  public void testExecuteSetVariablesTyped() {
    ...
    VariableMap variables = createVariables().putValueTyped("aVariableName", stringValue("abc"))
  ...
  public void testExecuteSetVariableAndVariables() {
    ...
    // when
    caseService.withCaseExecution(caseExecutionId).setVariables(variables)
        .setVariable("aThirdVariable", 123).execute();
  ...
  public void testExecuteSetVariableAndVariablesTyped() {
    ...
    // when
    caseService.withCaseExecution(caseExecutionId).setVariables(variables)
        .setVariable("aThirdVariable", booleanValue(null)).execute();
  ...
  public void testExecuteSetVariableLocal() {
    ...
    caseService.withCaseExecution(caseExecutionId).setVariableLocal("aVariableName", "abc")
        .setVariableLocal("anotherVariableName", 999).execute();
  ...
  public void testExecuteSetVariableLocalAndVariablesLocal() {
    ...
    // when
    caseService.withCaseExecution(caseExecutionId).setVariablesLocal(variables)
        .setVariableLocal("aThirdVariable", 123).execute();
  ...
  public void testExecuteRemoveVariable() {
    ...
    // an active case instance
    String caseInstanceId = caseService.withCaseDefinition(caseDefinitionId)
        .setVariable("aVariableName", "abc").setVariable("anotherVariableName", 999).create()
        .getId();
    ...
    // when
    caseService.withCaseExecution(caseExecutionId).removeVariable("aVariableName")
        .removeVariable("anotherVariableName").execute();
  ...
  public void testExecuteRemoveVariableAndVariables() {
    ...
    // an active case instance
    String caseInstanceId = caseService.withCaseDefinition(caseDefinitionId)
        .setVariable("aVariableName", "abc").setVariable("anotherVariableName", 999)
        .setVariable("aThirdVariable", 123).create().getId();
    ...
    // when
    caseService.withCaseExecution(caseExecutionId).removeVariables(variableNames)
        .removeVariable("aThirdVariable").execute();
  ...
  public void testExecuteRemoveVariableLocal() {
    ...
    // when
    caseService.withCaseExecution(caseExecutionId).removeVariableLocal("aVariableName")
        .removeVariableLocal("anotherVariableName").execute();
  ...
  public void testExecuteRemoveVariableLocalAndVariablesLocal() {
    ...
    caseService.withCaseExecution(caseExecutionId).setVariableLocal("aVariableName", "abc")
        .setVariableLocal("anotherVariableName", 999).setVariableLocal("aThirdVariable", 123)
        .execute();
    ...
    // when
    caseService.withCaseExecution(caseExecutionId).removeVariablesLocal(variableNames)
        .removeVariableLocal("aThirdVariable").execute();
  ...
  public void testExecuteRemoveVariableAndVariablesLocal() {
    ...
    caseService.withCaseExecution(caseExecutionId).setVariable("aVariableName", "abc")
        .setVariable("anotherVariableName", 999).setVariableLocal("aThirdVariable", 123).execute();
  ...
  public void testExecuteRemoveAndSetSameVariable() {
    ...
    // an active case instance
    caseService.withCaseDefinition(caseDefinitionId).setVariable("aVariableName", "abc").create()
        .getId();
    ...
    try {
      // when
      caseService.withCaseExecution(caseExecutionId).removeVariable("aVariableName")
          .setVariable("aVariableName", "xyz").execute();
    } catch (NotValidException e) {
      // then
      assertTextPresent(
          "Cannot set and remove a variable with the same variable name: 'aVariableName' within a command.",
          e.getMessage());
    }
  }
  ...
  public void testExecuteRemoveAndSetSameLocal() {
    ...
    try {
      // when
      caseService.withCaseExecution(caseExecutionId).setVariableLocal("aVariableName", "xyz")
          .removeVariableLocal("aVariableName").execute();
    } catch (NotValidException e) {
      // then
      assertTextPresent(
          "Cannot set and remove a variable with the same variable name: 'aVariableName' within a command.",
  ...
  public void testGetVariables() {
    ...
    // an active case instance
    caseService.withCaseDefinition(caseDefinitionId).setVariable("aVariableName", "abc")
        .setVariable("anotherVariableName", 999).create().getId();
  ...
  public void testGetVariablesWithVariableNames() {
    ...
    // an active case instance
    caseService.withCaseDefinition(caseDefinitionId).setVariable("aVariableName", "abc")
        .setVariable("anotherVariableName", 999).setVariable("thirVariable", "xyz").create()
        .getId();
  ...
  public void testGetVariableTyped() {
    ...
    ObjectValue serializedObjectValue = caseService.getVariableTyped(caseExecutionId,
        "aSerializedObject", false);
  ...
  public void testSetVariableLocal() {
    ...
    // query by case instance id
    List<VariableInstance> result = runtimeService.createVariableInstanceQuery()
        .caseExecutionIdIn(caseInstanceId).list();
  ...
  public void testGetVariableTypedLocal() {
    ...
    caseService.withCaseExecution(caseExecutionId).setVariableLocal("aVariableName", "abc")
        .setVariableLocal("anotherVariableName", 999).setVariableLocal("aSerializedObject",
            Variables.objectValue(Arrays.asList("1", "2")).create())
        .execute();

    // when
    StringValue stringValue = caseService.getVariableLocalTyped(caseExecutionId, "aVariableName");
    ObjectValue objectValue = caseService.getVariableLocalTyped(caseExecutionId,
        "aSerializedObject");
    ObjectValue serializedObjectValue = caseService.getVariableLocalTyped(caseExecutionId,
        "aSerializedObject", false);
  ...
  public void testRemoveVariable() {
    ...
    // a deployed case definition
    // and an active case instance
    caseService.withCaseDefinitionByKey("oneTaskCase").setVariable("aVariableName", "abc").create()
        .getId();
  ...
  public void testRemoveVariables() {
    ...
    caseService.withCaseDefinitionByKey("oneTaskCase").setVariables(variables)
        .setVariable("aThirdVariable", "def").create().getId();
  ...
  public void testCreateCaseInstanceById() {
    ...
    CaseDefinition caseDefinition = repositoryService.createCaseDefinitionQuery()
        .caseDefinitionKey("loanApplication").singleResult();
  ...
  public void testCreateCaseInstanceByKey() {
    ...
    CaseInstance caseInstance = caseService.withCaseDefinitionByKey(caseDefinition.getKey())
        .create();
  ...
  public void testCaseExecutionQuery() {
    ...
    CaseExecution casePlanModelExecution = caseService.createCaseExecutionQuery()
        .activityId("CasePlanModel_1").singleResult();

    assertNotNull(casePlanModelExecution);

    CaseExecution stageExecution = caseService.createCaseExecutionQuery().activityId("PI_Stage_1")
        .singleResult();

    assertNotNull(stageExecution);

    CaseExecution humanTaskExecution = caseService.createCaseExecutionQuery()
        .activityId("PI_HumanTask_6").singleResult();
  ...
  public void testGetVariablesTypedByEmptyList() {
    ...
    // when
    Map<String, Object> variables = caseService.getVariablesTyped(caseInstanceId,
  ...
  public void testGetVariablesLocalByEmptyList() {
    ...
    // when
    Map<String, Object> variables = caseService.getVariablesLocal(caseInstanceId,
        new ArrayList<String>());
  ...
  public void testGetVariablesLocalTypedByEmptyList() {
    ...
    // when
    Map<String, Object> variables = caseService.getVariablesLocalTyped(caseInstanceId,
        new ArrayList<String>(), false);
