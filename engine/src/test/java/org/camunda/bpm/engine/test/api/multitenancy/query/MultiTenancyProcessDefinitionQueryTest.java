...
public class MultiTenancyProcessDefinitionQueryTest extends PluggableProcessEngineTestCase {
  ...
  protected static final BpmnModelInstance emptyProcess = Bpmn
      .createExecutableProcess(PROCESS_DEFINITION_KEY).done();
  ...
  public void testQueryByTenantIdsIncludeDefinitionsWithoutTenantId() {
    ProcessDefinitionQuery query = repositoryService.createProcessDefinitionQuery()
        .tenantIdIn(TENANT_ONE).includeProcessDefinitionsWithoutTenantId();
    ...
    query = repositoryService.createProcessDefinitionQuery().tenantIdIn(TENANT_ONE, TENANT_TWO)
        .includeProcessDefinitionsWithoutTenantId();
  ...
  public void testQueryByKey() {
    ...
    query = repositoryService.createProcessDefinitionQuery()
        .processDefinitionKey(PROCESS_DEFINITION_KEY).withoutTenantId();
    // one definition without tenant id
    assertThat(query.count(), is(1L));

    query = repositoryService.createProcessDefinitionQuery()
        .processDefinitionKey(PROCESS_DEFINITION_KEY).tenantIdIn(TENANT_ONE);
  ...
  public void testQueryByLatestNoTenantIdSet() {
    ...
    ProcessDefinitionQuery query = repositoryService.createProcessDefinitionQuery()
        .processDefinitionKey(PROCESS_DEFINITION_KEY).latestVersion();
    // one definition for each tenant
    assertThat(query.count(), is(3L));

    Map<String, ProcessDefinition> processDefinitionsForTenant = getProcessDefinitionsForTenant(
        query.list());
  ...
  public void testQueryByLatestWithTenantId() {
    ...
    ProcessDefinitionQuery query = repositoryService.createProcessDefinitionQuery()
        .processDefinitionKey(PROCESS_DEFINITION_KEY).latestVersion().tenantIdIn(TENANT_ONE);
    ...
    query = repositoryService.createProcessDefinitionQuery()
        .processDefinitionKey(PROCESS_DEFINITION_KEY).latestVersion().tenantIdIn(TENANT_TWO);
  ...
  public void testQueryByLatestWithoutTenantId() {
    ...
    ProcessDefinitionQuery query = repositoryService.createProcessDefinitionQuery()
        .processDefinitionKey(PROCESS_DEFINITION_KEY).latestVersion().withoutTenantId();
  ...
  public void testQueryByLatestWithTenantIdsIncludeDefinitionsWithoutTenantId() {
    ...
    ProcessDefinitionQuery query = repositoryService.createProcessDefinitionQuery()
        .processDefinitionKey(PROCESS_DEFINITION_KEY).latestVersion()
        .tenantIdIn(TENANT_ONE, TENANT_TWO).includeProcessDefinitionsWithoutTenantId();
  ...
  protected Map<String, ProcessDefinition> getProcessDefinitionsForTenant(
  ...
  public void testQueryAuthenticatedTenant() {
    ...
    assertThat(
        query.tenantIdIn(TENANT_ONE, TENANT_TWO).includeProcessDefinitionsWithoutTenantId().count(),
        is(2L));
  }
