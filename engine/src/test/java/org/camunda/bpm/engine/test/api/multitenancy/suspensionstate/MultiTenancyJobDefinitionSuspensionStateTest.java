...
public class MultiTenancyJobDefinitionSuspensionStateTest {
  ...
  public void suspendAndActivateJobDefinitionsForAllTenants() {
    ...
    // first suspend
    engineRule.getManagementService().updateJobDefinitionSuspensionState()
  ...
  public void suspendAndActivateJobDefinitionsIncludingJobsForAllTenants() {
    ...
    // first suspend
    engineRule.getManagementService().updateJobDefinitionSuspensionState()
        .byProcessDefinitionKey(PROCESS_DEFINITION_KEY).includeJobs(true).suspend();
    ...
    // then activate
    engineRule.getManagementService().updateJobDefinitionSuspensionState()
        .byProcessDefinitionKey(PROCESS_DEFINITION_KEY).includeJobs(true).activate();
