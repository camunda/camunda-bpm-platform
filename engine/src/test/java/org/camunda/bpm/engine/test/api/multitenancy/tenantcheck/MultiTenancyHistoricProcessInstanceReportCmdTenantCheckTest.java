...
public class MultiTenancyHistoricProcessInstanceReportCmdTenantCheckTest {
  ...
  @Test
  public void getReportByStartedBeforeByMonthNoAuthenticatedTenants() {
    testRule.deployForTenant(TENANT_ONE, BPMN_PROCESS);

    setCurrentTime(2016, 3, 21, 8, 0); // 21.04.2016 8:00
    startAndCompleteProcessInstance(null);

    setCurrentTime(2016, 4, 13, 8, 0); // 13.05.2016 8:00
    startAndCompleteProcessInstance(null);

    identityService.setAuthentication("user", null, null);

    Calendar calendar = Calendar.getInstance();
    calendar.set(2016, 4, 1, 0, 0, 0); // 01.05.2016 00:00
  ...
  @Test
  public void getReportByStartedBeforeByMonthWithAuthenticatedTenant() {
    testRule.deployForTenant(TENANT_ONE, BPMN_PROCESS);
    ...
    DurationReportResult durationReportResult = result.get(0);
    assertThat(durationReportResult.getPeriod(), is(4));
    assertThat(durationReportResult.getPeriodUnit().name(), is("MONTH"));
  }

  @Test
  public void getReportByStartedBeforeByMonthDisabledTenantCheck() {
    testRule.deployForTenant(TENANT_ONE, BPMN_PROCESS);
  ...
  @Test
  public void getReportByStartedAfterByMonthNoAuthenticatedTenants() {
    testRule.deployForTenant(TENANT_ONE, BPMN_PROCESS);
  ...
  @Test
  public void getReportByStartedAfterByMonthWithAuthenticatedTenant() {
    testRule.deployForTenant(TENANT_ONE, BPMN_PROCESS);
  ...
  @Test
  public void getReportByStartedAfterByMonthDisabledTenantCheck() {
    testRule.deployForTenant(TENANT_ONE, BPMN_PROCESS);
