...
public class ProcessModels {
  ...
  public static final BpmnModelInstance UNSUPPORTED_ACTIVITIES = Bpmn.createExecutableProcess(PROCESS_KEY)
   ...
   public static final BpmnModelInstance BASIC_CONDITONAL_SOURCE_PROCESS = Bpmn.createExecutableProcess("BSCP")
	...
	public static final BpmnModelInstance SUB_PROCESS_CONDITIONAL_SOURCE_PROCESS=
			Bpmn.createExecutableProcess("SCSP")
			.startEvent()
			.parallelGateway("fork")
				.subProcess("subProcess")
					.embeddedSubProcess()
					.startEvent()
							.userTask("TaskA").endEvent()
				.subProcessDone()
				.endEvent()
			.moveToLastGateway()
				.userTask("TaskB")
	...
	public static final BpmnModelInstance SUB_PROCESS_CONDITIONAL_TARGET_PROCESS =Bpmn.createExecutableProcess("SCTP")
			.startEvent()
			.parallelGateway("fork")
				.subProcess("subProcess")
					.embeddedSubProcess()
					.startEvent()
						.exclusiveGateway().condition("validdocument", "${documentvalid==true}")
							.userTask("TaskA").endEvent()
						.moveToLastGateway().condition("validdocument", "${documentvalid==false}")
							.userTask("TaskC").endEvent()
				.subProcessDone()
				.endEvent()
			.moveToLastGateway()
				.userTask("TaskB")
	...
	public static final BpmnModelInstance MULTIPLE_CONDITION_SOURCE_PROCESS=Bpmn.createExecutableProcess("MSCP")
			...
			.parallelGateway("fork")
				...
				.endEvent()
			.moveToLastGateway()
				.subProcess("subProcessTwo")
					.embeddedSubProcess()
					.startEvent()
						.userTask("TaskB").endEvent()
				.subProcessDone()		
			    .endEvent()
			.done();
	public static final BpmnModelInstance MULTIPLE_CONDITION_TARGET_PROCESS=Bpmn.createExecutableProcess("MCTP")
			...
			.parallelGateway("fork")
				.subProcess("subProcessOne")
					.embeddedSubProcess()
					.startEvent()
						.exclusiveGateway().condition("conditionOne", "${firstcondition==true}")
							.userTask("TaskA").endEvent()
						.moveToLastGateway().condition("conditionOne", "${firstcondition==false}")
							.userTask("TaskC").endEvent()
				.subProcessDone()
				.endEvent()
			.moveToLastGateway()
				.subProcess("subProcessTwo")
					.embeddedSubProcess()
					.startEvent()
						.exclusiveGateway().condition("conditionTwo", "${secondcondition==true}")
							.userTask("TaskB").endEvent()
						.moveToLastGateway().condition("conditionTwo", "${secondcondition==false}")
							.userTask("TaskD").endEvent()
				.subProcessDone()
				.endEvent()
			.done();	
}
