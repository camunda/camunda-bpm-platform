...
import org.camunda.bpm.engine.test.authorization.service.ExecuteCommandDelegate;
import org.camunda.bpm.engine.test.authorization.service.ExecuteCommandListener;
import org.camunda.bpm.engine.test.authorization.service.ExecuteCommandTaskListener;
import org.camunda.bpm.engine.test.authorization.service.ExecuteQueryDelegate;
import org.camunda.bpm.engine.test.authorization.service.ExecuteQueryListener;
import org.camunda.bpm.engine.test.authorization.service.ExecuteQueryTaskListener;
import org.camunda.bpm.engine.test.authorization.service.MyDelegationService;
import org.camunda.bpm.engine.test.authorization.service.MyFormFieldValidator;
import org.camunda.bpm.engine.test.authorization.service.MyServiceTaskActivityBehaviorExecuteCommand;
import org.camunda.bpm.engine.test.authorization.service.MyServiceTaskActivityBehaviorExecuteQuery;
import org.camunda.bpm.engine.test.authorization.service.MyTaskService;
...
public class DelegationAuthorizationTest extends AuthorizationTest {
  ...
  @Deployment(resources = {"org/camunda/bpm/engine/test/authorization/DelegationAuthorizationTest.testCustomStartFormHandlerExecutesQuery.bpmn20.xml"})
  ...
  @Deployment(resources = {"org/camunda/bpm/engine/test/authorization/DelegationAuthorizationTest.testCustomTaskFormHandlerExecutesQuery.bpmn20.xml"})
  ...
  @Deployment(resources = {"org/camunda/bpm/engine/test/authorization/DelegationAuthorizationTest.testJavaDelegateExecutesQueryAfterUserCompletesTask.bpmn20.xml"})
  ...
  @Deployment(resources = {"org/camunda/bpm/engine/test/authorization/DelegationAuthorizationTest.testJavaDelegateExecutesCommandAfterUserCompletesTask.bpmn20.xml"})
