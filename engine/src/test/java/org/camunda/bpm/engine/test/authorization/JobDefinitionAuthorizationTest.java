...
public class JobDefinitionAuthorizationTest extends AuthorizationTest {
  ...
  // set job definition priority (no cascade) ///////////////////////////////

  public void testSetJobDefinitionPriorityWithoutAuthorization() {
    // given
    JobDefinition jobDefinition = selectJobDefinitionByProcessDefinitionKey(TIMER_BOUNDARY_PROCESS_KEY);
  ...
  public void testSetJobDefinitionPriorityWithUpdatePermissionOnProcessDefinition() {
    // given
    JobDefinition jobDefinition = selectJobDefinitionByProcessDefinitionKey(TIMER_BOUNDARY_PROCESS_KEY);
    ...
    // then
    jobDefinition = selectJobDefinitionByProcessDefinitionKey(TIMER_BOUNDARY_PROCESS_KEY);
    assertNotNull(jobDefinition);
    assertEquals(42, (int) jobDefinition.getJobPriority());

    // clean operation log
    clearOpLog();
  }

  public void testSetJobDefinitionPrioritWithUpdatePermissionOnAnyProcessDefinition() {
    // given
    JobDefinition jobDefinition = selectJobDefinitionByProcessDefinitionKey(TIMER_BOUNDARY_PROCESS_KEY);
  ...
  // set job definition priority including jobs ////////////////////////////

  public void testSetJobDefinitionPriorityCascadeWithoutAuthorization() {
    // given
    startProcessInstanceByKey(TIMER_BOUNDARY_PROCESS_KEY);
    JobDefinition jobDefinition = selectJobDefinitionByProcessDefinitionKey(TIMER_BOUNDARY_PROCESS_KEY);
    ...
    try {
      // when
      managementService.setJobDefinitionPriority(jobDefinition.getId(), 42, true);
  ...
  public void testSetJobDefinitionPriorityCascadeWithUpdatePermissionOnProcessInstance() {
    // given
    String processInstanceId = startProcessInstanceByKey(TIMER_BOUNDARY_PROCESS_KEY).getId();
    JobDefinition jobDefinition = selectJobDefinitionByProcessDefinitionKey(TIMER_BOUNDARY_PROCESS_KEY);
  ...
  public void testSetJobDefinitionPriorityCascadeWithUpdatePermissionOnAnyProcessInstance() {
    // given
    String processInstanceId = startProcessInstanceByKey(TIMER_BOUNDARY_PROCESS_KEY).getId();
    JobDefinition jobDefinition = selectJobDefinitionByProcessDefinitionKey(TIMER_BOUNDARY_PROCESS_KEY);
  ...
  public void testSetJobDefinitionPriorityCascadeWithUpdateInstancePermissionOnProcessDefinition() {
    // given
    String processInstanceId = startProcessInstanceByKey(TIMER_BOUNDARY_PROCESS_KEY).getId();
    JobDefinition jobDefinition = selectJobDefinitionByProcessDefinitionKey(TIMER_BOUNDARY_PROCESS_KEY);
  ...
  public void testSetJobDefinitionPriorityCascadeWithUpdateInstancePermissionOnAnyProcessDefinition() {
    // given
    String processInstanceId = startProcessInstanceByKey(TIMER_BOUNDARY_PROCESS_KEY).getId();
    JobDefinition jobDefinition = selectJobDefinitionByProcessDefinitionKey(TIMER_BOUNDARY_PROCESS_KEY);
  ...
  // reset job definition priority ///////////////////////////////

  public void testResetJobDefinitionPriorityWithoutAuthorization() {
    // given
    JobDefinition jobDefinition = selectJobDefinitionByProcessDefinitionKey(TIMER_BOUNDARY_PROCESS_KEY);
  ...
  public void testResetJobDefinitionPriorityWithUpdatePermissionOnProcessDefinition() {
    // given
    JobDefinition jobDefinition = selectJobDefinitionByProcessDefinitionKey(TIMER_BOUNDARY_PROCESS_KEY);
  ...
  public void testResetJobDefinitionPrioritWithUpdatePermissionOnAnyProcessDefinition() {
    // given
    JobDefinition jobDefinition = selectJobDefinitionByProcessDefinitionKey(TIMER_BOUNDARY_PROCESS_KEY);
