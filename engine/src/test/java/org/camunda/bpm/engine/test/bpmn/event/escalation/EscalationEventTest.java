...
public class EscalationEventTest extends PluggableProcessEngineTestCase {
  ...
  public void testThrowEscalationEventHierarchical() {
    ...
    assertEquals(2, taskService.createTaskQuery().count());
    // the non-interrupting boundary event inside the subprocess should catch the escalation event
    // (and not the boundary event on process)
  ...
  public void testBoundaryEventWithoutEscalationCode() {
    ...
    assertEquals(2, taskService.createTaskQuery().count());
    // the non-interrupting boundary event without escalationCode should catch the escalation event
    // (and all other escalation events)
    assertEquals(1,
        taskService.createTaskQuery().taskName("task after catched escalation").count());
    // and continue the subprocess
    assertEquals(1, taskService.createTaskQuery().taskName("task in subprocess").count());
  ...
  public void testBoundaryEventWithEmptyEscalationCode() {
    ...
    assertEquals(2, taskService.createTaskQuery().count());
    // the non-interrupting boundary event with empty escalationCode should catch the escalation
  ...
  public void testBoundaryEventWithoutEscalationRef() {
    ...
    assertEquals(2, taskService.createTaskQuery().count());
    // the non-interrupting boundary event without escalationRef should catch the escalation event
    // (and all other escalation events)
    assertEquals(1,
        taskService.createTaskQuery().taskName("task after catched escalation").count());
    // and continue the subprocess
  ...
  public void testInterruptingEscalationBoundaryEventOnMultiInstanceSubprocess() {
    ...
    // the interrupting boundary event should catch the first escalation event and cancel all
    // instances of the subprocess
    assertEquals(1, taskService.createTaskQuery().count());
    assertEquals(1,
        taskService.createTaskQuery().taskName("task after catched escalation").count());
  }
  ...
  public void FAILING_testImplicitNonInterruptingEscalationBoundaryEvent() {
    ...
    assertEquals(2, taskService.createTaskQuery().count());
    // the implicit non-interrupting boundary event ('cancelActivity' is not defined) should catch
  ...
  public void testInterruptingEscalationBoundaryEventOnCallActivity() {
    ...
    // the interrupting boundary event on call activity should catch the escalation event and cancel
    // the called process
    assertEquals(1, taskService.createTaskQuery().count());
    assertEquals(1,
        taskService.createTaskQuery().taskName("task after catched escalation").count());
  ...
  @Deployment(resources = {
      "org/camunda/bpm/engine/test/bpmn/event/escalation/testOutputVariablesWhileThrowEscalation.bpmn20.xml",
  ...
  public void testPropagateOutputVariablesWhileThrowEscalation() {
    ...
    variables.put("input", 42);
    String processInstanceId = runtimeService
        .startProcessInstanceByKey("EscalationParentProcess", variables).getId();
  ...
  @Deployment(resources = {
      "org/camunda/bpm/engine/test/bpmn/event/escalation/testOutputVariablesWhileThrowEscalationTwoLevels.bpmn20.xml",
      "org/camunda/bpm/engine/test/bpmn/event/escalation/EscalationEventTest.escalationParent.bpmn20.xml" })
  ...
  @Deployment(resources = {
      "org/camunda/bpm/engine/test/bpmn/event/escalation/testOutputVariablesWhileThrowEscalationThreeLevels.bpmn20.xml",
      "org/camunda/bpm/engine/test/bpmn/event/escalation/EscalationEventTest.escalationParent.bpmn20.xml" })
  ...
  @Deployment(resources = {
      "org/camunda/bpm/engine/test/bpmn/event/escalation/testOutputVariablesWhileThrowEscalationInSubProcess.bpmn20.xml",
      "org/camunda/bpm/engine/test/bpmn/event/escalation/EscalationEventTest.escalationParent.bpmn20.xml" })
  ...
  @Deployment(resources = {
      "org/camunda/bpm/engine/test/bpmn/event/escalation/testOutputVariablesWhileThrowEscalationInSubProcessThreeLevels.bpmn20.xml",
      "org/camunda/bpm/engine/test/bpmn/event/escalation/EscalationEventTest.escalationParent.bpmn20.xml" })
  ...
  @Deployment(resources = {
      "org/camunda/bpm/engine/test/bpmn/event/escalation/testOutputVariablesWhileThrowEscalation2.bpmn20.xml",
      "org/camunda/bpm/engine/test/bpmn/event/escalation/EscalationEventTest.escalationParent.bpmn20.xml" })
