...
public class MessageBoundaryEventTest extends PluggableProcessEngineTestCase {
  ...
  public void testSingleBoundaryMessageEvent() {
    ...
    execution = runtimeService.createExecutionQuery().messageEventSubscriptionName("messageName")
        .singleResult();
  ...
  public void testDoubleBoundaryMessageEventSameMessageId() {
    ...
    try {
      repositoryService.createDeployment().addClasspathResource(
          "org/camunda/bpm/engine/test/bpmn/event/message/MessageBoundaryEventTest.testDoubleBoundaryMessageEventSameMessageId.bpmn20.xml")
          .deploy();
      fail(
          "Deployment should fail because Activiti cannot handle two boundary message events with same messageId.");
    } catch (Exception e) {
      assertTextPresent(
          "Cannot have more than one message event subscription with name 'messageName' for scope 'task'",
          e.getMessage());
  ...
  public void testDoubleBoundaryMessageEvent() {
    ...
    try {
      ...
      assertTextPresent("does not have a subscription to a message event with name 'messageName_2'",
          e.getMessage());
    }
    ...
    execution1 = runtimeService.createExecutionQuery().messageEventSubscriptionName("messageName_1")
        .singleResult();
    assertNull(execution1);
    execution2 = runtimeService.createExecutionQuery().messageEventSubscriptionName("messageName_2")
        .singleResult();
  ...
  public void testBoundaryMessageEventInsideSubprocess() {
    ...
    // this time the boundary events are placed on a user task that is contained inside a sub
    // process
  ...
  public void testBoundaryMessageEventOnSubprocessAndInsideSubprocess() {
    ...
    execution = runtimeService.createExecutionQuery().messageEventSubscriptionName("messageName2")
        .singleResult();
    assertNotNull(execution);
  ...
  public void testBoundaryMessageEventOnSubprocessAndInsideSubprocessMultiInstance() {
    ...
    executions = runtimeService.createExecutionQuery().messageEventSubscriptionName("messageName2")
        .list();
    assertNotNull(executions);
    ...
    executions = runtimeService.createExecutionQuery().messageEventSubscriptionName("messageName")
        .list();
  ...
  /**
   * Triggering one boundary event should not remove the event subscription of a boundary event for
   * a concurrent task
   */
  @Deployment
  public void testBoundaryMessageEventConcurrent() {
    ...
    EventSubscription eventSubscriptionTask1 = runtimeService.createEventSubscriptionQuery()
        .activityId("messageBoundary1").singleResult();
    assertNotNull(eventSubscriptionTask1);

    EventSubscription eventSubscriptionTask2 = runtimeService.createEventSubscriptionQuery()
        .activityId("messageBoundary2").singleResult();
    ...
    assertNotNull(runtimeService.createEventSubscriptionQuery().activityId("messageBoundary2")
        .singleResult());
  ...
  public void testExpressionInBoundaryMessageEventName() {
    ...
    Execution execution = runtimeService.createExecutionQuery()
        .messageEventSubscriptionName("messageName-bar").singleResult();
    assertNotNull(execution);
