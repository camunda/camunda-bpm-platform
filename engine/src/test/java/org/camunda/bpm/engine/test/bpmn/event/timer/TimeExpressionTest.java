...
public class TimeExpressionTest extends PluggableProcessEngineTestCase {
  ...
  @Deployment(resources = {
      "org/camunda/bpm/engine/test/bpmn/event/timer/IntermediateTimerEventTest.testExpression.bpmn20.xml" })
  ...
  public void testTimeExpressionWithoutTime() throws Exception {
    ...
    assertEquals(new SimpleDateFormat("yyyy-MM-dd").format(dt),
  ...
  public void testTimeExpressionWithoutDay() throws Exception {
    ...
    assertEquals(new SimpleDateFormat("yyyy-MM").format(dt),
        new SimpleDateFormat("yyyy-MM").format(dueDate));
  }
  ...
  public void testTimeExpressionWithoutMonth() throws Exception {
    ...
    assertEquals(new SimpleDateFormat("yyyy").format(dt),
        new SimpleDateFormat("yyyy").format(dueDate));
  }
}
