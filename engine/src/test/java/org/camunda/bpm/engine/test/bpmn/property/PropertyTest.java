...
public class PropertyTest extends PluggableProcessEngineTestCase {
  ...
  public void testUserTaskSrcProperty() {
    ...
    // ProcessInstance pi =
    // deployer.getProcessService().startProcessInstanceByKey("testUserTaskSrcProperty", vars);
    //
    ...
    // deployer.getProcessService().findChildExecutions(pi.getId());
    ...
    // assertEquals("test", deployer.getProcessService().getVariable(childExecution.getId(),
    // "myVar"));
    ...
    // assertEquals("new_value", deployer.getProcessService().getVariable(childExecution.getId(),
    // "myVar"));
    // assertEquals("test", deployer.getProcessService().getVariable(childExecution.getId(),
    // "inputVar"));
    // assertNull(deployer.getProcessService().getVariable(pi.getId(), "myVar"));
  ...
  public void testUserTaskSrcExprProperty() {
    ...
    // ProcessInstance pi =
    // deployer.getProcessService().startProcessInstanceByKey("testUserTaskSrcExprProperty", vars);
    //
    ...
    // assertEquals(address, deployer.getProcessService().getVariable(childExecutionId,
    // "orderAddress"));
  ...
  public void testUserTaskDstProperty() {
    ...
    // ProcessInstance pi =
    // deployer.getProcessService().startProcessInstanceByKey("testUserTaskDstProperty");
    // List<Execution> childExecutions =
    // deployer.getProcessService().findChildExecutions(pi.getId());
    // String childExecutionId = childExecutions.get(0).getId();
    //
  ...
  public void testUserTaskDstExprProperty() {
    ...
    // vars.put("order", order);
    // ProcessInstance pi =
    // deployer.getProcessService().startProcessInstanceByKey("testUserTaskDstExprProperty", vars);
    //
    // List<Execution> childExecutions =
    // deployer.getProcessService().findChildExecutions(pi.getId());
    // String childExecutionId = childExecutions.get(0).getId();
    ...
    //
    // Order orderAfterComplete = (Order) deployer.getProcessService().getVariable(pi.getId(),
    // "order");
  ...
  public void testUserTaskLinkProperty() {
    ...
    // vars.put("inputVar", "test");
    // ProcessInstance pi =
    // deployer.getProcessService().startProcessInstanceByKey("testUserTaskLinkProperty", vars);
    //
    // // Variable 'taskVar' should only be visible for the task scoped execution
    // Execution childExecution =
    // deployer.getProcessService().findChildExecutions(pi.getId()).get(0);
    // assertEquals("test", deployer.getProcessService().getVariable(childExecution.getId(),
    // "taskVar"));
    // assertEquals("test", deployer.getProcessService().getVariable(childExecution.getId(),
    // "inputVar"));
    ...
    // assertEquals("new_value", deployer.getProcessService().getVariable(taskScopedExecutionId,
    // "taskVar"));
    // assertEquals("test", deployer.getProcessService().getVariable(taskScopedExecutionId,
    // "inputVar"));
