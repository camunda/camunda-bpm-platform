...
public class ExecutionListenerCases {
  ...
  public static final Iterable<Object[]> TASK_OR_STAGE_CASES = Arrays.asList(new Object[][] {
      // class delegate
  ...
  public static final Iterable<Object[]> EVENTLISTENER_OR_MILESTONE_CASES = Arrays
      .asList(new Object[][] {
          // class delegate
          { new ClassExecutionListenerSpec(CaseExecutionListener.CREATE) },
          { new ClassExecutionListenerSpec(CaseExecutionListener.SUSPEND) },
  ...
  public static final Iterable<Object[]> CASE_PLAN_MODEL_CASES = Arrays.asList(new Object[][] {
      // class delegate
      { new ClassExecutionListenerSpec(CaseExecutionListener.CREATE) },
      { new ClassExecutionListenerSpec(CaseExecutionListener.COMPLETE) },
      { new ClassExecutionListenerSpec(CaseExecutionListener.SUSPEND) },
