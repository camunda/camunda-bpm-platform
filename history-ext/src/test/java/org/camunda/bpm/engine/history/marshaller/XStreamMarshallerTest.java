...
public class XStreamMarshallerTest {
  ...
  public void marshallFromHistoricActivityInstanceEventToStringAndBack() {
    ...
    HistoricActivityInstanceEventEntity fromXml = (HistoricActivityInstanceEventEntity) xstream.fromXML(eventAsString);
  ...
  public void marshallHistoricActivityInstanceEventEntityFromFile() {
    HistoricActivityInstanceEventEntity fromXml = (HistoricActivityInstanceEventEntity) xstream.fromXML(EventResources
        .getHistoricActivityInstanceEventEntityAsStream());
  ...
  protected void assertHistoricActivityInstanceEventEntity(final HistoricActivityInstanceEventEntity event, final HistoricActivityInstanceEventEntity fromXml) {
