...
public class MockProcessArchiveSupport extends ProcessArchiveSupport {
  ...
  protected void installProcessArchives() {   
    ...
    ProcessArchive mockArchive1 = new ProcessArchiveImpl(mockDescriptor1,null,null,this);
    ProcessArchive mockArchive2 = new ProcessArchiveImpl(mockDescriptor2,null,null,this);
