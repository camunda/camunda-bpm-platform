...
public class StartJcaExecutorServiceStep extends MBeanDeploymentOperationStep {
  ...
  public void performOperationStep(MBeanDeploymentOperation operationContext) {
    ...
    serviceContainer.startService(ServiceTypes.BPM_PLATFORM, JmxRuntimeContainerDelegate.SERVICE_NAME_EXECUTOR, new JcaExecutorServiceDelegate(executorService));
