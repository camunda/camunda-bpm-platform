...
import static org.camunda.bpm.model.dmn.impl.DmnModelConstants.DMN_ELEMENT_CONDITION;
...
public class ConditionImpl extends DmnModelElementInstanceImpl implements Condition {
  ...
  public static void registerType(ModelBuilder modelBuilder) {
    ModelElementTypeBuilder typeBuilder = modelBuilder.defineType(Condition.class, DMN_ELEMENT_CONDITION)
