...
public class TestFoxPlatformClientAsEjbModule extends AbstractFoxPlatformIntegrationTest {
  ...
  public static EnterpriseArchive onePaAsLib() {    
    ...
    WebArchive testJar = ShrinkWrap.create(WebArchive.class, "test.war")
      ...
      .addClass(TestFoxPlatformClientAsEjbModule.class);
  ...
  @Test
  @OperateOnDeployment("onePaAsLib")
  ...
  @Test
  @OperateOnDeployment("twoPasAsLib")
  ...
  @Test
  @OperateOnDeployment("paAsEjbModule")
