 ...
 */
package com.camunda.fox.platform.test.functional.context;
...
import com.camunda.fox.platform.test.functional.context.beans.CalledProcessDelegate;
import com.camunda.fox.platform.test.functional.context.beans.DelegateAfter;
import com.camunda.fox.platform.test.functional.context.beans.DelegateBefore;
...
public class CallActivityContextSwitchTest extends AbstractFoxPlatformIntegrationTest {
  ...
  public static WebArchive createProcessArchiveDeplyoment() {    
    return initWebArchiveDeployment("mainDeployment.war")
      ...
      .addAsResource("com/camunda/fox/platform/test/functional/context/CallActivityContextSwitchTest.mainProcessSync.bpmn20.xml")
      .addAsResource("com/camunda/fox/platform/test/functional/context/CallActivityContextSwitchTest.mainProcessSyncNoWait.bpmn20.xml")
      .addAsResource("com/camunda/fox/platform/test/functional/context/CallActivityContextSwitchTest.mainProcessASync.bpmn20.xml")
      .addAsResource("com/camunda/fox/platform/test/functional/context/CallActivityContextSwitchTest.mainProcessASyncBefore.bpmn20.xml")
      .addAsResource("com/camunda/fox/platform/test/functional/context/CallActivityContextSwitchTest.mainProcessASyncAfter.bpmn20.xml");
  }
  ...
  public static WebArchive createSecondProcessArchiveDeployment() {    
    return initWebArchiveDeployment("calledDeployment.war")
      ...
      .addAsResource("com/camunda/fox/platform/test/functional/context/CallActivityContextSwitchTest.calledProcessSync.bpmn20.xml")
      .addAsResource("com/camunda/fox/platform/test/functional/context/CallActivityContextSwitchTest.calledProcessSyncNoWait.bpmn20.xml")
      .addAsResource("com/camunda/fox/platform/test/functional/context/CallActivityContextSwitchTest.calledProcessASync.bpmn20.xml");
  }
  ...
  public void testNoWaitState() {
    ...
    runtimeService.startProcessInstanceByKey("mainProcessSyncNoWait", processVariables);
  ...
  public void testMainASyncCalledSync() {
    ...
    waitForJobExecutorToProcessAllJobs(6000, 200);
