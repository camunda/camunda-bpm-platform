...
public class TestDeploymentWithDroolsTaskFails_internal extends AbstractFoxPlatformIntegrationTest {
  ...
  public void testXmlInvalid() {
    ...
    final String resourceName = "com/camunda/fox/platform/test/functional/drools/TestDeploymentWithDroolsTaskFails.testDeployDroolsFails.bpmn20.xml";
