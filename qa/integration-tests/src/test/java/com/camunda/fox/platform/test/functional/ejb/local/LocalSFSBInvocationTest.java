...
import com.camunda.fox.platform.test.functional.ejb.local.bean.LocalSFSBClientDelegateBean;
import com.camunda.fox.platform.test.functional.ejb.local.bean.LocalSFSBean;
...
public class LocalSFSBInvocationTest extends AbstractFoxPlatformIntegrationTest {
  ...
  public static WebArchive processArchive() {    
    return initWebArchiveDeployment()
      ...
      .addAsResource("com/camunda/fox/platform/test/functional/ejb/local/LocalSFSBInvocationTest.testInvokeBean.bpmn20.xml")      
