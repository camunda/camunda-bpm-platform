...
import com.camunda.fox.platform.test.functional.ejb.local.bean.LocalSingletonBean;
import com.camunda.fox.platform.test.functional.ejb.local.bean.LocalSingletonBeanClientDelegateBean;
...
public class LocalSingletonBeanInvocationTest extends AbstractFoxPlatformIntegrationTest {
  ...
  public static WebArchive processArchive() {    
    return initWebArchiveDeployment()
      ...
      .addAsResource("com/camunda/fox/platform/test/functional/ejb/local/LocalSingletonBeanInvocationTest.testInvokeBean.bpmn20.xml")      
