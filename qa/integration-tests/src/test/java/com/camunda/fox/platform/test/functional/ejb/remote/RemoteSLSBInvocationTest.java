...
import com.camunda.fox.platform.test.functional.ejb.remote.bean.RemoteSLSBClientDelegateBean;
import com.camunda.fox.platform.test.functional.ejb.remote.bean.RemoteSLSBean;
...
public class RemoteSLSBInvocationTest extends AbstractFoxPlatformIntegrationTest {
  ...
  public static WebArchive processArchive() {    
    return initWebArchiveDeployment()
      ...
      .addAsResource("com/camunda/fox/platform/test/functional/ejb/remote/RemoteSLSBInvocationTest.testInvokeBean.bpmn20.xml");      
  }
