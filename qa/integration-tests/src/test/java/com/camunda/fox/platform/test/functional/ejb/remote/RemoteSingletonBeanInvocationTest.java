...
import com.camunda.fox.platform.test.functional.ejb.remote.bean.RemoteSingletonBeanClientDelegateBean;
...
public class RemoteSingletonBeanInvocationTest extends AbstractFoxPlatformIntegrationTest {
  ...
  public static WebArchive processArchive() {    
    return initWebArchiveDeployment()
      ...
      .addAsResource("com/camunda/fox/platform/test/functional/ejb/remote/RemoteSingletonBeanInvocationTest.testInvokeBean.bpmn20.xml");      
  }
