...
public class TransactionIntegrationTest extends AbstractFoxPlatformIntegrationTest {
  ...
  public static WebArchive processArchive() {    
    return initWebArchiveDeployment()      
      ...
      .addAsResource("com/camunda/fox/platform/test/functional/transactions/TransactionIntegrationTest.testDelegateParticipateInApplicationTx.bpmn20.xml")
      .addAsResource("com/camunda/fox/platform/test/functional/transactions/TransactionIntegrationTest.testAsyncDelegateNewTx.bpmn20.xml")
      .addAsResource("com/camunda/fox/platform/test/functional/transactions/TransactionIntegrationTest.testProcessFailure.bpmn20.xml")
      .addAsResource("com/camunda/fox/platform/test/functional/transactions/TransactionIntegrationTest.testApplicationFailure.bpmn20.xml")
      .addAsResource("com/camunda/fox/platform/test/functional/transactions/TransactionIntegrationTest.testTxSuccess.bpmn20.xml")     
