 ...
 *
 */
public class HistoryPerformanceTest extends ProcessEnginePerformanceTestCase {
  ...
  private void executeQueries() {
    ...
    historyService.createHistoricProcessInstanceQuery().listPage(0, 15);

    historyService.createHistoricActivityInstanceQuery().count();
    historyService.createHistoricActivityInstanceQuery().listPage(0, 15);

    historyService.createHistoricTaskInstanceQuery().count();
    historyService.createHistoricTaskInstanceQuery().listPage(0, 15);
