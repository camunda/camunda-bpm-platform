...
public class TestFixture62 {
  ...
  public void startSingleTaskProcess() {
    ...
    ProcessInstance instance = runtimeService.startProcessInstanceByKey("TestFixture62.singleTaskProcess", processVariables);

    // set task variable
    setTaskLocalVariable(instance.getId(), "waitHere", "taskVariable", "taskVariableValue");
  }
  ...
  public void startConcurrentTaskProcess() {
    ...
    ProcessInstance instance = runtimeService.startProcessInstanceByKey("TestFixture62.concurrentTaskProcess", processVariables);

    // set task variables
    Execution execution1 = runtimeService.createExecutionQuery()
        .processInstanceId(instance.getId()).activityId("task1").singleResult();
    setSingleTaskLocalVariable(execution1, "taskVariable1", "taskVariableValue1");
    setExecutionLocalVariable(execution1, "localVariable1", "localVariableValue1");

    Execution execution2 = runtimeService.createExecutionQuery()
        .processInstanceId(instance.getId()).activityId("task2").singleResult();
    setSingleTaskLocalVariable(execution2, "taskVariable2", "taskVariableValue2");
    setExecutionLocalVariable(execution2, "localVariable2", "localVariableValue2");
  }
  ...
  public void startSingleEmbeddedSubprocessTaskProcess() {
    ...
    processVariables.put("processVariable", "processVariableValue");
    ProcessInstance instance = runtimeService.startProcessInstanceByKey("TestFixture62.singleEmbeddedSubprocess", processVariables);

    // set a subprocess local variable
    setExecutionLocalVariable(instance.getId(), "waitInside1", "subProcessVariable", "subProcessVariableValue");

    // set a task local variable
    setTaskLocalVariable(instance.getId(), "waitInside1", "taskVariable", "taskVariableValue");
  }
  ...
  public void startMultiInstanceSequentialSubprocess() {
    ...
    ProcessInstance instance = runtimeService.startProcessInstanceByKey("TestFixture62.multiInstanceSequentialSubprocess", processVariables);
  ...
  protected void setExecutionLocalVariable(String processInstanceId, String activityId, String variableName, String variableValue) {
    List<Execution> executions = runtimeService.createExecutionQuery().processInstanceId(processInstanceId).activityId(activityId).list();
    for (Execution execution : executions) {
      setExecutionLocalVariable(execution, variableName, variableValue);
    }
  }

  protected void setExecutionLocalVariable(Execution execution, String variableName, String variableValue) {
    runtimeService.setVariableLocal(execution.getId(), variableName, variableValue);
  }

  protected void setTaskLocalVariable(String processInstanceId, String activityId, String variableName, String variableValue) {
    List<Execution> executions = runtimeService.createExecutionQuery().processInstanceId(processInstanceId).activityId(activityId).list();
    for (Execution execution : executions) {
      setSingleTaskLocalVariable(execution, variableName, variableValue);
    }
  }

  protected void setSingleTaskLocalVariable(Execution execution, String variableName, String variableValue) {
