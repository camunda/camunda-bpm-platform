 ...
 */
package org.camunda.bpm.qa.upgrade.scenarios.rolling.externalTask;
...
public class ProcessWithExternalTaskScenario {
  ...
  public static String deploy() {
    return "org/camunda/bpm/qa/upgrade/rolling/processWithExternalTask.bpmn20.xml";
  }
  ...
  public static ScenarioSetup startProcessWithFetch() {
    return new ScenarioSetup() {
      public void execute(ProcessEngine engine, String scenarioName) {
        engine.getRuntimeService().startProcessInstanceByKey(PROCESS_DEF_KEY, scenarioName);
        engine.getExternalTaskService().fetchAndLock(1, WORKER_ID)
