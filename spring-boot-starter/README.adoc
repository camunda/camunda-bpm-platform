...
CAUTION: With 2.0.0 a lot of refactorings are being made. Do not switch if you expect/require a stable runtime. If you do switch, be prepared to rearrange your application.properties and imports. We are happy to get feedback.
