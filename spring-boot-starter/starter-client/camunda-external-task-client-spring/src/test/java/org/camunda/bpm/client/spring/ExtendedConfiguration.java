...
public class ExtendedConfiguration {
  ...
  @Configuration
  @EnableExternalTaskSubscriptions(baseUrl = "http://localhost:8080/rest", id = "First")
  static class FirstConfig {

    @ExternalTaskSubscription(topicName = "methodSubscription", externalTaskClientIds = "externalTaskClientFirst")
    @Bean
  ...
  @Configuration
  @EnableExternalTaskSubscriptions(baseUrl = "http://localhost:8090/rest", id = SecondConfig.CLIENT_ID)
