...
public class ClientRegistrar implements ImportBeanDefinitionRegistrar {
  ...
  public ClientRegistrar(Class<? extends ClientFactory> externalTaskClientFactoryClass) {
  ...
  public void registerBeanDefinitions(AnnotationMetadata importingClassMetadata,
    ...
    registerExternalTaskClient(importingClassMetadata, beanDefinitionRegistry);
  }
  ...
  protected void registerExternalTaskClient(AnnotationMetadata importingClassMetadata,
    ...
    if (beanDefinitionRegistry.containsBeanDefinition(BEAN_NAME)) {
      LOG.beanCreationSkipped(importingClassMetadata.getClassName(), BEAN_NAME,
          beanDefinitionRegistry.getBeanDefinition(BEAN_NAME).getFactoryBeanName());
      return;
    }
    ...
    EnableExternalTaskClient annotation =
        AnnotationUtil.get(EnableExternalTaskClient.class, importingClassMetadata);
