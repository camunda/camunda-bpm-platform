...
@Conditional(CamundaSpringSecurityDisableAutoConfiguration.ClientsNotConfiguredCondition.class)
public class CamundaSpringSecurityDisableAutoConfiguration {

  private static final Logger logger = LoggerFactory.getLogger(CamundaSpringSecurityDisableAutoConfiguration.class);

  public static class ClientsNotConfiguredCondition extends ClientsConfiguredCondition {
    @Override
