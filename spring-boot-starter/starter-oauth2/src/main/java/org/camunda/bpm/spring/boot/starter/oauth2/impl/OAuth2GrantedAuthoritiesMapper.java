 ...
 */
package org.camunda.bpm.spring.boot.starter.oauth2.impl;

import org.camunda.bpm.spring.boot.starter.oauth2.OAuth2Properties;
  ...
  public Collection<? extends GrantedAuthority> mapAuthorities(Collection<? extends GrantedAuthority> authorities) {
    ...
    authorities.forEach(authority -> {
      if (authority instanceof OAuth2UserAuthority) {
        ...
        Object groupName = oauth2UserAuthority.getAttributes().get(groupNameAttribute);
        ...
        if (groupName instanceof Collection) {
          //noinspection unchecked
          Collection<String> groupsAttribute = (Collection<String>) groupName;
          ...
          String groupsAttribute = (String) groupName;
          ...
          logger.error("Could not map granted authorities, unsupported attribute type: {}", groupName.getClass());
        }
      }
    });
