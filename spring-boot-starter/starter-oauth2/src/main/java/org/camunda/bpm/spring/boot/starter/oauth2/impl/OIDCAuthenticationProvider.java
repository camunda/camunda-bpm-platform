...
public class OIDCAuthenticationProvider extends ContainerBasedAuthenticationProvider {
  ...
  private static final Logger logger = LoggerFactory.getLogger(OIDCAuthenticationProvider.class);
  ...
  public AuthenticationResult extractAuthenticatedUser(HttpServletRequest request, ProcessEngine engine) {
    ...
    if (!(principal instanceof OidcUser)) {
      logger.debug("Principal is not an OIDC user, it is {}", principal.getClass());
      return AuthenticationResult.unsuccessful();
    }
