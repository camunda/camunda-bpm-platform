...
@ConditionalOnClass(Contributor.class)
...
public class CamundaBpmActuatorConfiguration {
  ...
  public Contributor jobExecutorHealthIndicator(JobExecutor jobExecutor) {
    return new JobExecutorHealthIndicator(jobExecutor);
  }

  @Bean
  @ConditionalOnMissingBean(name = "processEngineHealthIndicator")
  public Contributor processEngineHealthIndicator(ProcessEngine processEngine) {
