...
public class TelemetryDataNonPaIT extends AbstractCamundaAutoConfigurationIT {
  ...
  public void shouldAddCamundaIntegration() {
    ...
    boolean integration = (boolean) camundaIntegration.get(CamundaIntegration.SPRING_BOOT_STARTER);
    assertThat(integration).isTrue();
  }
}