...
import org.camunda.bpm.cockpit.test.sample.plugin.embedded.resources.ExampleResourceOverride;
import org.camunda.bpm.cockpit.test.sample.plugin.embedded.resources.ResourceOverridePlugin;
...
public class EmbeddedPluginResourceOverrideTest extends AbstractCockpitCoreTest {

  @Deployment
  public static Archive<?> createDeployment() {

    WebArchive archive = createBaseDeployment("test-embedded.war")
          .addAsServiceProvider(CockpitPlugin.class, ResourceOverridePlugin.class)
          .addPackages(true, ResourceOverridePlugin.class.getPackage())
  ...
  public void shouldServeWebappEmbeddedPluginAsset() throws Exception {
    ...
    assertThat(result.getEntity(String.class)).isEqualTo(ExampleResourceOverride.REPLACED);
  }
}
