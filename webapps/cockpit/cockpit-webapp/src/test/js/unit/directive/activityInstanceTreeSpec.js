  ...
  return describe('directives', function() {
    ...
    describe('tree directive', function() {
      ...
      it('should render tree', inject(function($rootScope, $compile) {
        ...
        // then
        expect($('body').html()).toBe('<button ng-show="!activityInstanceTree.isOpen" type="button" ng-click="open(activityInstanceTree)" class="invisible-button ng-scope" style="display: none;">    <i class="icon-plus"></i>  </button>  <button ng-show="activityInstanceTree.isOpen" type="button" ng-click="close(activityInstanceTree)" class="invisible-button ng-scope" style="">    <i class="icon-minus"></i>  </button><span id="instance_1" class="clickable-tree-node ng-scope ng-binding" ng-class="{\'activity-highlight\' : activityInstanceTree.isSelected}"></span><ul ng-show="activityInstanceTree.isOpen" class="ng-scope" style=""><!-- ngRepeat: item in getChildren() | orderBy:\'name\' --><li ng-repeat="item in getChildren() | orderBy:\'name\'" class="none-list-style ng-scope"><button ng-show="!activityInstanceTree.isOpen" type="button" ng-click="open(activityInstanceTree)" class="invisible-button ng-scope" style="display: none;">    <i class="icon-plus"></i>  </button>  <button ng-show="activityInstanceTree.isOpen" type="button" ng-click="close(activityInstanceTree)" class="invisible-button ng-scope" style="">    <i class="icon-minus"></i>  </button><span id="instance_2" class="clickable-tree-node ng-scope ng-binding" ng-class="{\'activity-highlight\' : activityInstanceTree.isSelected}"></span><ul ng-show="activityInstanceTree.isOpen" class="ng-scope" style=""><!-- ngRepeat: item in getChildren() | orderBy:\'name\' --><li ng-repeat="item in getChildren() | orderBy:\'name\'" class="none-list-style ng-scope"><span id="instance_3" class="clickable-tree-node ng-scope ng-binding" ng-class="{\'activity-highlight\' : activityInstanceTree.isSelected}"></span></li><li ng-repeat="item in getChildren() | orderBy:\'name\'" class="none-list-style ng-scope"><span id="instance_4" class="clickable-tree-node ng-scope ng-binding" ng-class="{\'activity-highlight\' : activityInstanceTree.isSelected}"></span></li><li ng-repeat="item in getChildren() | orderBy:\'name\'" class="none-list-style ng-scope"><span id="transition_instance_1" class="clickable-tree-node ng-scope ng-binding" ng-class="{\'activity-highlight\' : activityInstanceTree.isSelected}"></span></li></ul></li><li ng-repeat="item in getChildren() | orderBy:\'name\'" class="none-list-style ng-scope"><button ng-show="!activityInstanceTree.isOpen" type="button" ng-click="open(activityInstanceTree)" class="invisible-button ng-scope" style="display: none;">    <i class="icon-plus"></i>  </button>  <button ng-show="activityInstanceTree.isOpen" type="button" ng-click="close(activityInstanceTree)" class="invisible-button ng-scope" style="">    <i class="icon-minus"></i>  </button><span id="instance_5" class="clickable-tree-node ng-scope ng-binding" ng-class="{\'activity-highlight\' : activityInstanceTree.isSelected}"></span><ul ng-show="activityInstanceTree.isOpen" class="ng-scope" style=""><!-- ngRepeat: item in getChildren() | orderBy:\'name\' --><li ng-repeat="item in getChildren() | orderBy:\'name\'" class="none-list-style ng-scope"><span id="instance_6" class="clickable-tree-node ng-scope ng-binding" ng-class="{\'activity-highlight\' : activityInstanceTree.isSelected}"></span></li><li ng-repeat="item in getChildren() | orderBy:\'name\'" class="none-list-style ng-scope"><span id="instance_7" class="clickable-tree-node ng-scope ng-binding" ng-class="{\'activity-highlight\' : activityInstanceTree.isSelected}"></span></li><li ng-repeat="item in getChildren() | orderBy:\'name\'" class="none-list-style ng-scope"><span id="transition_instance_2" class="clickable-tree-node ng-scope ng-binding" ng-class="{\'activity-highlight\' : activityInstanceTree.isSelected}"></span></li></ul></li><li ng-repeat="item in getChildren() | orderBy:\'name\'" class="none-list-style ng-scope"><span id="instance_8" class="clickable-tree-node ng-scope ng-binding" ng-class="{\'activity-highlight\' : activityInstanceTree.isSelected}"></span></li><li ng-repeat="item in getChildren() | orderBy:\'name\'" class="none-list-style ng-scope"><button ng-show="!activityInstanceTree.isOpen" type="button" ng-click="open(activityInstanceTree)" class="invisible-button ng-scope" style="display: none;">    <i class="icon-plus"></i>  </button>  <button ng-show="activityInstanceTree.isOpen" type="button" ng-click="close(activityInstanceTree)" class="invisible-button ng-scope" style="">    <i class="icon-minus"></i>  </button><span id="instance_9" class="clickable-tree-node ng-scope ng-binding" ng-class="{\'activity-highlight\' : activityInstanceTree.isSelected}"></span><ul ng-show="activityInstanceTree.isOpen" class="ng-scope" style=""><!-- ngRepeat: item in getChildren() | orderBy:\'name\' --><li ng-repeat="item in getChildren() | orderBy:\'name\'" class="none-list-style ng-scope"><button ng-show="!activityInstanceTree.isOpen" type="button" ng-click="open(activityInstanceTree)" class="invisible-button ng-scope" style="display: none;">    <i class="icon-plus"></i>  </button>  <button ng-show="activityInstanceTree.isOpen" type="button" ng-click="close(activityInstanceTree)" class="invisible-button ng-scope" style="">    <i class="icon-minus"></i>  </button><span id="instance_10" class="clickable-tree-node ng-scope ng-binding" ng-class="{\'activity-highlight\' : activityInstanceTree.isSelected}"></span><ul ng-show="activityInstanceTree.isOpen" class="ng-scope" style=""><!-- ngRepeat: item in getChildren() | orderBy:\'name\' --><li ng-repeat="item in getChildren() | orderBy:\'name\'" class="none-list-style ng-scope"><span id="instance_11" class="clickable-tree-node ng-scope ng-binding" ng-class="{\'activity-highlight\' : activityInstanceTree.isSelected}"></span></li><li ng-repeat="item in getChildren() | orderBy:\'name\'" class="none-list-style ng-scope"><span id="instance_12" class="clickable-tree-node ng-scope ng-binding" ng-class="{\'activity-highlight\' : activityInstanceTree.isSelected}"></span></li><li ng-repeat="item in getChildren() | orderBy:\'name\'" class="none-list-style ng-scope"><span id="instance_13" class="clickable-tree-node ng-scope ng-binding" ng-class="{\'activity-highlight\' : activityInstanceTree.isSelected}"></span></li><li ng-repeat="item in getChildren() | orderBy:\'name\'" class="none-list-style ng-scope"><span id="instance_14" class="clickable-tree-node ng-scope ng-binding" ng-class="{\'activity-highlight\' : activityInstanceTree.isSelected}"></span></li><li ng-repeat="item in getChildren() | orderBy:\'name\'" class="none-list-style ng-scope"><span id="instance_15" class="clickable-tree-node ng-scope ng-binding" ng-class="{\'activity-highlight\' : activityInstanceTree.isSelected}"></span></li></ul></li></ul></li></ul>');
      }));
      ...
      it('should close tree', inject(function($rootScope, $compile) {
        ...
        // then
        expect($('body').html()).toBe('<button ng-show="!activityInstanceTree.isOpen" type="button" ng-click="open(activityInstanceTree)" class="invisible-button ng-scope" style="">    <i class="icon-plus"></i>  </button>  <button ng-show="activityInstanceTree.isOpen" type="button" ng-click="close(activityInstanceTree)" class="invisible-button ng-scope" style="display: none;">    <i class="icon-minus"></i>  </button><span id="instance_1" class="clickable-tree-node ng-scope ng-binding" ng-class="{\'activity-highlight\' : activityInstanceTree.isSelected}"></span><ul ng-show="activityInstanceTree.isOpen" class="ng-scope" style="display: none;"><!-- ngRepeat: item in getChildren() | orderBy:\'name\' --><li ng-repeat="item in getChildren() | orderBy:\'name\'" class="none-list-style ng-scope"><button ng-show="!activityInstanceTree.isOpen" type="button" ng-click="open(activityInstanceTree)" class="invisible-button ng-scope" style="display: none;">    <i class="icon-plus"></i>  </button>  <button ng-show="activityInstanceTree.isOpen" type="button" ng-click="close(activityInstanceTree)" class="invisible-button ng-scope" style="">    <i class="icon-minus"></i>  </button><span id="instance_2" class="clickable-tree-node ng-scope ng-binding" ng-class="{\'activity-highlight\' : activityInstanceTree.isSelected}"></span><ul ng-show="activityInstanceTree.isOpen" class="ng-scope" style=""><!-- ngRepeat: item in getChildren() | orderBy:\'name\' --><li ng-repeat="item in getChildren() | orderBy:\'name\'" class="none-list-style ng-scope"><span id="instance_3" class="clickable-tree-node ng-scope ng-binding" ng-class="{\'activity-highlight\' : activityInstanceTree.isSelected}"></span></li><li ng-repeat="item in getChildren() | orderBy:\'name\'" class="none-list-style ng-scope"><span id="instance_4" class="clickable-tree-node ng-scope ng-binding" ng-class="{\'activity-highlight\' : activityInstanceTree.isSelected}"></span></li><li ng-repeat="item in getChildren() | orderBy:\'name\'" class="none-list-style ng-scope"><span id="transition_instance_1" class="clickable-tree-node ng-scope ng-binding" ng-class="{\'activity-highlight\' : activityInstanceTree.isSelected}"></span></li></ul></li><li ng-repeat="item in getChildren() | orderBy:\'name\'" class="none-list-style ng-scope"><button ng-show="!activityInstanceTree.isOpen" type="button" ng-click="open(activityInstanceTree)" class="invisible-button ng-scope" style="display: none;">    <i class="icon-plus"></i>  </button>  <button ng-show="activityInstanceTree.isOpen" type="button" ng-click="close(activityInstanceTree)" class="invisible-button ng-scope" style="">    <i class="icon-minus"></i>  </button><span id="instance_5" class="clickable-tree-node ng-scope ng-binding" ng-class="{\'activity-highlight\' : activityInstanceTree.isSelected}"></span><ul ng-show="activityInstanceTree.isOpen" class="ng-scope" style=""><!-- ngRepeat: item in getChildren() | orderBy:\'name\' --><li ng-repeat="item in getChildren() | orderBy:\'name\'" class="none-list-style ng-scope"><span id="instance_6" class="clickable-tree-node ng-scope ng-binding" ng-class="{\'activity-highlight\' : activityInstanceTree.isSelected}"></span></li><li ng-repeat="item in getChildren() | orderBy:\'name\'" class="none-list-style ng-scope"><span id="instance_7" class="clickable-tree-node ng-scope ng-binding" ng-class="{\'activity-highlight\' : activityInstanceTree.isSelected}"></span></li><li ng-repeat="item in getChildren() | orderBy:\'name\'" class="none-list-style ng-scope"><span id="transition_instance_2" class="clickable-tree-node ng-scope ng-binding" ng-class="{\'activity-highlight\' : activityInstanceTree.isSelected}"></span></li></ul></li><li ng-repeat="item in getChildren() | orderBy:\'name\'" class="none-list-style ng-scope"><span id="instance_8" class="clickable-tree-node ng-scope ng-binding" ng-class="{\'activity-highlight\' : activityInstanceTree.isSelected}"></span></li><li ng-repeat="item in getChildren() | orderBy:\'name\'" class="none-list-style ng-scope"><button ng-show="!activityInstanceTree.isOpen" type="button" ng-click="open(activityInstanceTree)" class="invisible-button ng-scope" style="display: none;">    <i class="icon-plus"></i>  </button>  <button ng-show="activityInstanceTree.isOpen" type="button" ng-click="close(activityInstanceTree)" class="invisible-button ng-scope" style="">    <i class="icon-minus"></i>  </button><span id="instance_9" class="clickable-tree-node ng-scope ng-binding" ng-class="{\'activity-highlight\' : activityInstanceTree.isSelected}"></span><ul ng-show="activityInstanceTree.isOpen" class="ng-scope" style=""><!-- ngRepeat: item in getChildren() | orderBy:\'name\' --><li ng-repeat="item in getChildren() | orderBy:\'name\'" class="none-list-style ng-scope"><button ng-show="!activityInstanceTree.isOpen" type="button" ng-click="open(activityInstanceTree)" class="invisible-button ng-scope" style="display: none;">    <i class="icon-plus"></i>  </button>  <button ng-show="activityInstanceTree.isOpen" type="button" ng-click="close(activityInstanceTree)" class="invisible-button ng-scope" style="">    <i class="icon-minus"></i>  </button><span id="instance_10" class="clickable-tree-node ng-scope ng-binding" ng-class="{\'activity-highlight\' : activityInstanceTree.isSelected}"></span><ul ng-show="activityInstanceTree.isOpen" class="ng-scope" style=""><!-- ngRepeat: item in getChildren() | orderBy:\'name\' --><li ng-repeat="item in getChildren() | orderBy:\'name\'" class="none-list-style ng-scope"><span id="instance_11" class="clickable-tree-node ng-scope ng-binding" ng-class="{\'activity-highlight\' : activityInstanceTree.isSelected}"></span></li><li ng-repeat="item in getChildren() | orderBy:\'name\'" class="none-list-style ng-scope"><span id="instance_12" class="clickable-tree-node ng-scope ng-binding" ng-class="{\'activity-highlight\' : activityInstanceTree.isSelected}"></span></li><li ng-repeat="item in getChildren() | orderBy:\'name\'" class="none-list-style ng-scope"><span id="instance_13" class="clickable-tree-node ng-scope ng-binding" ng-class="{\'activity-highlight\' : activityInstanceTree.isSelected}"></span></li><li ng-repeat="item in getChildren() | orderBy:\'name\'" class="none-list-style ng-scope"><span id="instance_14" class="clickable-tree-node ng-scope ng-binding" ng-class="{\'activity-highlight\' : activityInstanceTree.isSelected}"></span></li><li ng-repeat="item in getChildren() | orderBy:\'name\'" class="none-list-style ng-scope"><span id="instance_15" class="clickable-tree-node ng-scope ng-binding" ng-class="{\'activity-highlight\' : activityInstanceTree.isSelected}"></span></li></ul></li></ul></li></ul>');
      }));
