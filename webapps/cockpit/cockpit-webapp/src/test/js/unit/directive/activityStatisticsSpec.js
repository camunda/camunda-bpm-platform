define([ 'angular',
         ...
         'cockpit/resources/processDiagramResource',
    ...
    describe('activity statistics directive', function() {
      ...
      beforeEach(function () {
        angular.module('testmodule', [ 'cockpit.directives', 
                                       'cockpit.resources', 
                                       'cockpit.resources.process.diagram', 
                                       'ngResource',
      ...
      it('should show number of current instances on activity', inject(function($rootScope, $compile, $httpBackend) {
        ...
        // then
        expect(element.html()).toContain('<div id="ServiceTask_1" class="bpmnElement" style="position: absolute; left: 382px; top: 237px; width: 100px; height: 80px;"><p class="currentActivityCount">14</p></div>');
      ...
      it('should show number new number of current instances on activity after process process definition id has been changed', inject(function($rootScope, $compile, $httpBackend) {
        ...
        // then
        expect(element.html()).toContain('<div id="ServiceTask_1" class="bpmnElement" style="position: absolute; left: 382px; top: 237px; width: 100px; height: 80px;"><p class="currentActivityCount">1.5k</p></div>');
