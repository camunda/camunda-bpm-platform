...
.controller('ProcessDefinitionCtrl', [
    '$scope', '$routeParams', '$location', 'Error', 'ProcessDefinitionResource', 'ProcessInstanceResource',
    function($scope, $routeParams, $location, Error, ProcessDefinitionResource, ProcessInstanceResource) {
