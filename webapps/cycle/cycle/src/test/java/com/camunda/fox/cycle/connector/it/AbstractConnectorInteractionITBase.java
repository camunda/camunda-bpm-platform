...
import com.camunda.fox.cycle.connector.test.util.TestHelper;
...
//------------------------------- IMPORTANT GETTER / SETTER ------------------------------//
  ...
  public String getLhsModelLocation() {
    return "/com/camunda/fox/cycle/roundtrip/repository/test-lhs.bpmn";
  }
  ...
  public String getRhsModelLocation() {
    return "/com/camunda/fox/cycle/roundtrip/repository/test-rhs.bpmn";
  }
