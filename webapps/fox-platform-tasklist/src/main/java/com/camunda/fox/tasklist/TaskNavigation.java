...
public class TaskNavigation implements Serializable {
  ...
  public List<GroupTasksLink> getGroupTasksLinks() {
    if (groupTasksLinks == null) {
      ...
      List<String> groups = foxIdentityService.getGroupsByUserId(currentIdentity.getCurrentUser().getUsername());
  ...
  public List<ColleaguesTasksLink> getColleaguesTasksLinks() {
    if (colleaguesTasksLinks == null) {
      ...
      List<com.camunda.fox.tasklist.identity.User> colleagues = foxIdentityService.getColleaguesByUserId(currentIdentity.getCurrentUser().getUsername());
      for (com.camunda.fox.tasklist.identity.User colleague : colleagues) {
