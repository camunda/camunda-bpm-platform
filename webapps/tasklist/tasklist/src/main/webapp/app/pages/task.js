...
define(["angular"], function(angular) {
  ...
  var Controller = function($rootScope, $scope, $location, $routeParams, Forms, Notifications, EngineApi) {
  ...
  Controller.$inject = ["$rootScope", "$scope", "$location", "$routeParams", "Forms", "Notifications", "EngineApi"];
