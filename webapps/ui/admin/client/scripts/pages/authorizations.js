    ...
    controller: [
      ...
      function($scope,   pageService, $routeParams,   $modal,   AuthorizationResource,   Notifications,   $location, $translate) {
        ...
        $scope.permissionMap = {
          ...
          6: [ 'READ', 'UPDATE', 'DELETE', 'CREATE_INSTANCE', 'READ_INSTANCE', 'UPDATE_INSTANCE', 'RETRY_JOB', 'SUSPEND_INSTANCE', 'DELETE_INSTANCE', 'MIGRATE_INSTANCE', 'READ_TASK', 'UPDATE_TASK', 'TASK_ASSIGN', 'TASK_WORK', 'READ_HISTORY', 'DELETE_HISTORY' ],
          7: [ 'CREATE', 'READ', 'UPDATE', 'DELETE', 'TASK_ASSIGN', 'TASK_WORK', 'READ_HISTORY' ],
          8: [ 'CREATE', 'READ', 'UPDATE', 'DELETE', 'RETRY_JOB', 'SUSPEND' ],
          9: [ 'CREATE', 'READ', 'DELETE' ],
          10: [ 'READ', 'UPDATE', 'CREATE_INSTANCE', 'READ_HISTORY', 'DELETE_HISTORY' ],
          11: [ 'READ', 'UPDATE', 'CREATE', 'DELETE' ],
          12: [ 'CREATE', 'DELETE' ],
          13: [ 'READ', 'UPDATE', 'CREATE', 'DELETE', 'READ_HISTORY', 'DELETE_HISTORY', 'CREATE_BATCH_MIGRATE_PROCESS_INSTANCES', 'CREATE_BATCH_MODIFY_PROCESS_INSTANCES', 'CREATE_BATCH_RESTART_PROCESS_INSTANCES', 'CREATE_BATCH_DELETE_RUNNING_PROCESS_INSTANCES', 'CREATE_BATCH_DELETE_FINISHED_PROCESS_INSTANCES', 'CREATE_BATCH_DELETE_DECISION_INSTANCES', 'CREATE_BATCH_SET_JOB_RETRIES', 'CREATE_BATCH_SET_EXTERNAL_TASK_RETRIES', 'CREATE_BATCH_UPDATE_PROCESS_INSTANCES_SUSPEND' ],
          14: [ 'READ' ],
