    ...
    controller: [
      ...
      function($scope,   pageService, $routeParams,   $modal,   AuthorizationResource,   Notifications,   $location, $translate) {
        ...
        $scope.permissionMap = {
          ...
          6: [ 'READ', 'UPDATE', 'DELETE', 'CREATE_INSTANCE', 'READ_INSTANCE', 'UPDATE_INSTANCE', 'DELETE_INSTANCE', 'MIGRATE_INSTANCE', 'READ_TASK', 'UPDATE_TASK', 'TASK_ASSIGN', 'TASK_WORK', 'READ_HISTORY', 'DELETE_HISTORY', 'RETRY_JOB' ],
          7: [ 'CREATE', 'READ', 'UPDATE', 'DELETE', 'TASK_ASSIGN', 'TASK_WORK', 'READ_HISTORY' ],
          8: [ 'CREATE', 'READ', 'UPDATE', 'DELETE', 'RETRY_JOB' ],
