          ...
          processDefinitionService.list({
            ...
            camAPI.resource('process-definition').statistics({ rootIncidents: true })
              .then(function(processDefinitionStatistics) {
                var aggregatedStatistics = aggregateStatistics(processDefinitionStatistics);
                aggregateInstances(aggregatedStatistics);
                aggregateIncidents(aggregatedStatistics);
              });
