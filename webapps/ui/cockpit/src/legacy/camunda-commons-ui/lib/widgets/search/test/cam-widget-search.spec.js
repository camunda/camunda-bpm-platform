...
describe('Search Widget', function() {
  ...
  describe('local persitence', function() {
    ...
    it('allows to save a set of search criteria', function() {
      ...
      browser
        .executeScript('return JSON.parse(localStorage.getItem("camunda"))')
    ...
    describe('with groups', function() {
      ...
      it('stores the sets in separate groups', function() {
        browser
          .executeScript('localStorage.removeItem("camunda")')
          .then(function(res) {
            ...
            browser
              .executeScript(
                'return JSON.parse(localStorage.getItem("camunda"))'
              )
              .then(function(result) {
