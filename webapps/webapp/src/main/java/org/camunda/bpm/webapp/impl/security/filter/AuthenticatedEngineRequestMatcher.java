...
/**
 * <p>This is a {@link RequestMatcher} which authorizes all process engine api
  ...
  protected boolean isUriMatched(String uri, AppRequest request) {
    ...
    if(authentications == null) {
      ...
      if(matcher.matches() && matcher.groupCount() == 1) {
        ...
        boolean authenticated = authentications.hasAuthenticationForProcessEngine(engineName);
